...
[   
    ...
    CockpitItem("hal2000:ratoon_plushie","Ratoon Plushie","A life-sized plush of everyone's favorite mouse mechanic and the perfect co-pilot. They do not know when this was made, but it sure is cute!", ["Blaseball"], stars=2),
    ...
    CosmeticItem("hal2000:blender_head","Blender Head","Your mech has an oversized blender as a head. That is all. It is very cool-looking but impractical for actual combat.", ["Classic", "Whimsy"], stars=2),
    ...
    KitItem("hal2000:the_bagel","The Bagel", "This small ring can be thrown and then sized up, creating a miniature black hole inside of it that draws everything on the battlefield closer to it over time. Getting sucked in may lead to an existential crisis and/or death.", ["Anomalous"], stars=4),
