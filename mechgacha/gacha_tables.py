...
[
    ...
    WeaponItem("cheshire:gorgons_grace","Gorgon's Grace","Inscribed with terrifying images, this object calcifies and embrittles those that gaze upon it, corroding armor and spirit. Ranged",["Mythological"], stars=4),	
...
[
    ...
    BackItem("shork:apd_unit","APD Unit","A bulky scaffold surrounds your mech, making it much harder for incoming melee attacks to reach your chassis, as the mess of pipes and metal physically prevents foes from reaching it. Also handy if you would get stuck in a hole.", stars=1),
