...
bee = Mech("bee", [
    ...
    LegsItem("bee:dark_matter_propulsion", "Dark Matter Propulsion","The force that keeps everything apart and the universe expanding. It also makes your mech go fast!",["Aero","Space"], stars=2),
    ...
    CockpitItem("bee:orbital_cockpit","ORBital Cockpit","A transparent bubble with no gravity within it, controls floating around effortlessly where you need them to be, controlling it almost like a dance.",["Luminous","Space"],stars=1),
    ...
    BodyPlanItem("bee:comet_form","Comet Form","A long thin form, with one leg and 6 arm slots, trailing behind the cockpit and core like a comet trail.",{"legs": 1, "arms": 6}, stars=4,tags=("Space",)),
...
[
    PowerItem("hillexed:antimatter_tea","Antimatter Tea","A transparent container of hot antibeverage! A steel handle attached to glass lets you see the powerful magnets within. Drink it to unlock the vast wellspring of energy inside your mouth!",["Aqua"],stars=1),
    LegsItem("hillexed:teeny_mechanized_legs","Teeny Mechanized Legs","Someone wasn't clear about millimeters versus meters. It looks like someone turned a robotic arm upside-down, full of joints and motors. That can't possibly be a baby shoe on the end, can it?",["Whimsy"], stars=2),
    ArmsItem("hillexed:neutron_star_on_a_stick","Neutron Star on a Stick","The ultimate fishing rod. Cast the line to throw the white-hot neutron star towards something you want to grab, and once gravity sticks the two together, reel it in. If you're really good, you can set up an orbit!",["Kinetic","Space"],stars=1),
    BodyItem("hillexed:parabolic_block","Parabolic Block","A pancake-shaped glass cylinder, with attachment points along the edge. One side is curved into a mirrored parabolic depression, with three trusses holding up items to its focal point. The dish can reflect and concentrate energy into sensors, or lasers can bounce off the dish to make giant beams!",["Energy","Sensory"],stars=1),
    CockpitItem("hillexed:crochet_controls","Crochet Controls","Two levers with a hook at the end. Grab one in each hand and wrap them around the strings of fate and warp the universe. The strings make a nice soft place to rest tired heads.",["Mythical","Whimsy"]),
    BackItem("hillexed:charge_couple_device","Charge/Couple Device","A sensor array of tiny purple squares arranged in a grid, able to build pictures of energy and light. Incredibly sensitive and capable of taking pictures or video, especially if boosted by a parabolic dish, but that sensitivity can be overwhelmed by strong marriages.",["Sensory"], stars=2),
    WeaponItem("hillexed:info_dumper","Info Dumper","It looks like someone combined a backhoe with a cellphone. A data transmitter repurposed to overwhelm foes with information.",["Sensory"], stars=2),
    CosmeticItem("hillexed:glolf_patches","Glolf Patches","A decal of a square grid of emojis depicting an eagle's eye view of a game in progress. Mostly green, with some white and yellow circles, glolfers' animal signatures, and is that depicting a crack in reality?",["Anomalous","Blaseball"]),
    BodyPlanItem("hillexed:starfish_mode_legs","Starfish mode: Legs","Five legs spaced around the center parabolic dish. If you balance the weight, the parabolic dish can roll on its edge to get around!", {"legs": 5}, stars=4,tags=("Aqua",)),
    BodyPlanItem("hillexed:starfish_mode_arms","Starfish mode: Arms","Five arms spaced symmetrically around the center. If you balance the weight, you can roll on its edge to get around!", {"arms": 5}, stars=3,tags=("Aqua",)),
    ...
    KitItem("hillexed:telescope","Telescope","A large tube that concentrates light to unlock the universe. Attach it to a mech for long-range observations, or have the mech hold it up to your cockpit.",["Luminous"],stars=1),
    KitItem("hillexed:slitless_spectrograph","Slitless Spectrograph","A tangle of fiber optics that splits light and projects a rainbow of colors covered by occasional black lines into a cockpit. Those lines tell you so much information about what molecules absorbed or reflected the light you're looking at!",["Sensory"], stars=3),
    BackItem("hillexed:death_bed","Death Bed","Part of your mecha is particularly soft and comfy, looking like a bed with a soft pillow. Despite the danger, the public swears it's worth climbing on your mecha to try lying on top of it. They'll die on this hill.",["Anomalous"], stars=3),
    BodyItem("hillexed:cassegrain_style_parabolic_block","Cassegrain-Style Parabolic Block","A drum-shaped hollow tube on its side, with attachment points along the outer edge. It focuses energy like a Cassegrain telescope into a point on the back: the perfect place to put advanced sensors... or a weapon that can send energy frontwards into a giant beam of mass destruction.",["Energy","Sensory"], stars=5),
...
[
    ...
    BodyPlanItem("cheshire:centaur","Centaur","With four legs, this bodyplan is typically fashioned into a centaur like configuration, allowing an additional back slot to be equipped as well.", {"legs": 4, "arms": 2, "back": 2},tags=("Horse",)),
...
[
    PowerItem("loading:kinetic_recycler","Kinetic Recycler","A kinetic generator powered by the grounded movement of the mech.",["Kinetic"], stars=2),
    LegsItem("loading:xr2","Loading's XR2","Long, double-jointed legs that give the mech a low crouching position while stationary, but a long stride.",["Classic"], stars=3),
    ...
    BackItem("loading:big_jacket","Big Jacket","A jacket that is two sizes too large. It flows in the wind, increasing evasion the more the mech moves.", ["Classic","cosmetic"], stars=1),
    WeaponItem("loading:hook_lash","Hook Lash","A whip with a spinning metal weight at the end that applies a random debuff on hit.",["Kinetic"], stars=2),
    WeaponItem("loading:lockjaw_needler","Lockjaw Needler","A set of low damage, hig fire rate pistols that corrode any surface their projectiles make contact with.",["Kinetic"], stars=3),
    KitItem("Loading:Power_Vents","Core Ventilation","In exchange for a more trimmed down mech, you gain the ability to explosively vent waste from your power source.",["Classic"], stars=4),
    BackItem("loading:big_mechs_jacket","Big Mechs Jacket","A long flowing jacket based on the Mechs bomber jacket that flows behind the mech as it moves obscuring the body. It increases evasion and throws off targeting systems the more the mech moves.", ["Blaseball","Classic","cosmetic"], stars=5),
]
)
...
[
    PowerItem("metanite64:sound_unit", "Sound Unit","An otherworldly amalgamation of sound chips from various retro game consoles. They probably shouldn't be intersecting each other like that. Or sparking so frequently.",["Sonic"]),
    ...
    ArmsItem("metanite64:sylish_circut", "Stylish Circuit","A copper plate resides within the left forearm, etched to resemble a keyboard. With the metallic tips of the right hand's fingers, one may close the giant circuit and produce the purest sound.",["Sonic"]),
    BodyItem("metanite64:soundbox_5_1", "SOUNDBOX 5.1","A solid cube covered in a fine mesh material. The power source hovers in the center.",["Sonic"]),
    CockpitItem("metanite64:gba_cartridge_collection", "GBA Cartridge Collection","a GBA and a number of custom cartridges. One of them is the Nanoloop 2, while the rest each play a different looping musical work.",["Classic","Sonic"], stars=2),
    BackItem("metanite64:roaring_wind", "Roaring Wind","Giant speakers. Bystanders may experience sudden deafness and strong winds.", ["Aero","Sonic","weapon"], stars=3),
    WeaponItem("metanite64:hathors_blade", "Hathor's Blade","A gift from the goddess of music, modified beyond recognition into both a keytar and a giant sword.",["Kinetic","Sonic"], stars=4),
    CosmeticItem("metanite64:waveform", "Waveform","A neon purple visual representation of the audio that the mech is currently playing. When the mech is silent, the waveform gradually shapeshifts between one of a few basic waves (sine, sawtooth, triangle, square).",["Luminous","Sonic"], stars=3),
    BackItem("metanite64:sheath_pockets", "Sheath Pockets","up to two extra weapons/tools can be stored alongside the mech's back accessory, fitting neatly into long pockets that criss-cross the mech's back.",["Sonic"], stars=2),
    WeaponItem("metanite64:batonatone", "Batonatone","That Otamatone looks pretty mad. Even looking at it wrong would probably get you whacked on the head.",["Kinetic","Sonic"], stars=2),
    WeaponItem("metanite64:don_and_ka", "Don and Ka","Two ancient ritual drumsticks, one orange and one blue. Taiko not included.",["Kinetic","Sonic"], stars=2),
    CosmeticItem("metanite64:golden_fiddle", "Golden Fiddle","It's said that a mere boy won this fiddle after besting the Devil in a duel of music. Some say that they've heard the fiddle playing itself.",["Mythical","Sonic"], stars=3),
    BackItem("metanite64:cobras_roar", "Cobra's Roar","5 star of the Roaring Wind. Even giant-er speakers. Either through deafness or death, the roar of the cobra is the last thing you'll get to hear.", ["Aero","Sonic","weapon"], stars=5),
]
)

deric = Mech("deric", 
[
    PowerItem("deric:spite_malace_or_anger","Spite, Malice, or Anger","The machine can only move when the pilot gives it their anger. It drains them of this, channeling it into the various systems.",["Relationship"]),
    ...
    ArmsItem("deric:impossible_anti_gravity_device","Impossible Anti-Gravity Device","A blocky stump points at an object to be lifted, and it rises, with no physical contact made.",["Anomalous","Kinetic"]),
    BodyItem("deric:a_gargantuan_slab_of_concrete_or_metal","A Gargantuan Slab of Concrete or Metal","There is some trim details and cracks, but the surface is otherwise unembelished and strangely barren.",["Terra"]),
    CockpitItem("deric:tethered_memory","Tethered Memory","Something that you miss dearly and wish you could take out of the mech.",["Relationship"]),
    BackItem("deric:jagged_spine","Jagged Spine","A horrific spine of jagged spikes and antennae."),
    WeaponItem("deric:improvised_weaponry","Improvised Weaponry","Anything it can pickup and lift can and will be its weapons.",["Kinetic"]),
    CosmeticItem("deric:concrete_body","Concrete Body","The mech is made almost entirely of concrete, with small bits of metal holding some sections together.",["Terra"]),
    ...
    CockpitItem("deric:tehtered_revival","Tethered Revival","Something that you miss dearly and wish you could take out of the mech. This version can be a living person or thing, like a lost pet or a loved one that passed away. They are alive, miraculously, but only inside the mech, they can never leave.",["Relationship"], stars=5),
]
)

syl = Mech("syl", 
[
    PowerItem("syl:energy_drink", "Energy Drink","A half-empty bottle of Diet Mountain Dew is hooked up to some kind of industrial pressure cooker. Better not touch it.",["Aqua"]),
    LegsItem("syl:peg_leg", "Peg Leg","This mech waddles along on six or seven wooden table legs, that somehow haven’t broken under the weight of the mech body.",["Whimsy"]),
    ArmsItem("syl:sticky_fingers", "Sticky Fingers","Instead of arms, this mech has dozens of huge novelty sticky hands, like the kind you would get at the dentist’s office if you didn’t have any cavities.",["Whimsy"]),
    BodyItem("syl:classic_forklift", "Classic Forklift","Improbably, the body of this mech appears to be a totally unmodified forklift. Better hope you’re forklift certified.",["Classic","Whimsy"]),
    CockpitItem("syl:fuzzy_dice", "Fuzzy Dice","Hanging from the windshield of your mech is a pair of fuzzy dice, like in an old taxi - but these are d20s, because you’re *quirky*.",["Whimsy"]),
    BackItem("syl:vending_machine", "Vending Machine","Tied to the back of the mech, possibly as a counterweight, is a battered old vending machine. The chips and cookies inside are somehow still intact despite years of mech battling.", ["Whimsy","cosmetic"]),
    WeaponItem("syl:plain_palms", "Plain Palms","This mech has no primary weapon, but prefers hand-to-hand combat. Specifically, it slaps people.",["Kinetic","Whimsy"]),
    CosmeticItem("syl:fallen_leaves", "Fallen Leaves","Old leaves from aspen trees are stuck to the sides and roof of this mech, as if it had just walked through a forest.",["Terra"]),
    BodyPlanItem("syl:dual_cockpits", "Dual Cockpits", "This mech has two seats for two pilots to sit alongside, if they are Drift Compatible. (A second player joins your mech in battle to split the task of operating it.)", {"cockpit": 2}, stars=5,tags=("Classic","Relationship")),
    CosmeticItem("syl:tied_up_horse", "Tied-Up Horse","This mech has a horse tied up to one of its legs. Not sure how it stays there in combat.",["Drone","Horse"]),
    CosmeticItem("syl:space_pinup", "Space Pinup","On the side of this mech, painted in bright neon colors, is a pinup of a shirtless Jar Jar Binks.",["Anomalous"], stars=3),
    CockpitItem("syl:single_tape_boombox", "Single-Tape Boombox","This mech has a retro boombox in the cockpit, and the tape that is unremovably stuck in it is “Greatest Hits Volume 1” by the Eagles.",["Classic"]),
    BackItem("syl:redbox_machine", "Redbox Machine", "Tied to the back of the mech, possibly as a counterweight, is a battered old Redbox machine, but the movies it dispenses are ones no one has ever seen before. Recently, you rented Goncharov (1973) by Martin Scorsese.", ["Anomalous","Whimsy","cosmetic"], stars=5),
    BackItem("syl:guavapon","Guavapon","Dispenses guavas of varying rarities, from Common to Legendary.",["Terra"],stars=2),
    CosmeticItem("syl:horse_head","Horse Head","Found in the bed of some mafioso, it drips blood constantly and occasionally eats oats.",["Horse"],stars=2),
    BackItem("syl:ponytail","Ponytail","Hair put up in a style associated with young girls and butch lesbians. Goes all the way down your mech’s back.",["Horse"],stars=2),
    WeaponItem("syl:horse_gun","Horse Gun","Fires a Clydesdale horse at relativistic speeds.",["Horse","Kinetic"],stars=5),
    WeaponItem("syl:horse_summoning_staff","Horse Summoning Staff","Summons normal but very angry horses to fight alongside you.",["Drone","Horse"],stars=3),
    KitItem("syl:bag_of_oats","Bag of Oats","It’s a bag of oats.",["Horse"],stars=2),
    WeaponItem("syl:curry_comb","Curry Comb","You can brush a horse with it, or throw it at someone in a pinch.",["Horse"],stars=1),
    LegsItem("syl:pony_express","Pony Express","Gives your mech the speed and stamina of a cross-country horseback mail courier.",["Horse"],stars=4),
    CosmeticItem("syl:horse_joker","Horse Joker","A paper playing card with a horse in clown makeup on it. +1 Mult for every horse-themed part equipped.",["Horse","Whimsy"],stars=3),
    CockpitItem("syl:saddle","Saddle","Found in village chests and underground mine shafts.",["Horse"],stars=1),
    CockpitItem("syl:epona","Epona","This iconic horse has blocky N64-era graphics but a pure heart. Pilots your mech for you and is “equipped” as a second cockpit.",["Drone","Horse"],stars=3),
    WeaponItem("syl:glue_factory","Glue Factory","Sprays Elmer’s glue at opponents. Don’t worry about what it was made out of.",["Horse"],stars=2),
    KitItem("syl:horse_girl_hypnosis","Horse Girl Hypnosis","Upon viewing this battered VHS tape, you become filled with the urge to put your hair in a ponytail and buy plastic horse models.",["Anomalous","Horse","cosmetic"],stars=5),
]
)
...
vel = Mech("vel", 
[
    PowerItem("vel:big_reactor", "Big Reactor","A big reactor thingy (prolly nuclear adjacent) that gets refueled by hoisting big cartridges in it.",["Classic"], stars=3),
    LegsItem("vel:sleek_legs", "Sleek Legs","Two sleek legs and high output thrusters.",["Classic"], stars=2),
    ArmsItem("vel:manipulators", "Manipulators", "Hand-like manipulators for big stuff, prolly some small claws on cranes for small stuff.",["Classic"]),
    BodyItem("vel:bipedal_frame", "Bipedal Frame","A human-like core (proportions may vary) with advanced sensors near the head or on it.",["Classic"]),
    CockpitItem("vel:external_cockpit", "External Cockpit","Outside cockpit? it has some periscopes/small windows as a backup.",["Classic"]),
    BackItem("vel:booster_backpack", "Booster Backpack","A backpack with one or two massive boosters with added drop tanks and some light equipment to like change the fuel cell, and ammo/technical equipment/jamming equipment.",["Classic"], stars=4),
    WeaponItem("vel:retractible_swords", "Battle-Tested Loadout", "A long carbine (think SVD or FRF-1), knife(ves)/retractible swords with the handle tucked in the forearms, plus countermeasures/stun launchers in the limbs.",["Classic","Kinetic"], stars=3),
    CosmeticItem("vel:pilot_emblem", "Pilot Emblem", "A big pilot emblem on a shoulder/skirt/side of the bust with a 2-3 colored paint scheme.",["Classic"], stars=2),
    BodyItem("vel:durability_frame", "Durability Frame","For improved durability, this body has differently-colored protection plates, big fatter limbs and a rugged drilling or artillery equipment backpack. There are added hardpoints, protection and ground mobility equipment. The sensor-heavy head wears a helmet.",["Classic"], stars=3),
    BodyItem("vel:ace_custom_frame", "Ace Custom Frame","This mech is a special personal unit of a famous ace/freedom fighter that's fighting for the betterment of humanity, it's based from a standard military/industrial unit, but was heavily modified and customized to fit a more exploration, reconaissance, sharpshooting role.",["Classic"], stars=5),
]
)

amutecrypt = Mech("amutecrypt", 
[
    PowerItem("amutecrypt:new_killer_star","New Killer Star","A caged sun, kept behind some thick shielding.",["Space"], stars=3),
    LegsItem("amutecrypt:the_awesome_foursome","The Awesome Foursome","4 heavy, industrial legs, designed for defence and redundancy.",["Classic"]),
    ArmsItem("amutecrypt:i_thought_about_the_army","I Thought About The Arm-y","Two industrial robotic arms.",["Classic"]),
    BodyItem("amutecrypt:the_part_formerly_known_as","! (The Part Formerly Known As)","A stout core with the arms mounted high up, like Atlas from Portal.",["Classic"]),
    CockpitItem("amutecrypt:okayish_computer","Okayish Computer","An AMD CPU hanging like a pair of fluffy dice would."),
    BackItem("amutecrypt:thrill_the_dj","Thrill The DJ","A big set of speakers.",["Sonic"]),
    WeaponItem("amutecrypt:shellshot","Shellshot","A launcher capable of firing adhesive, caltrops and other traps.",["Kinetic"]),
    CosmeticItem("amutecrypt:thunderbirds_are_coming_out","Thunderbirds Are Coming Out","Makes the mech look like a puppet."),
    KitItem("amutecrypt:disc_changer","Disk Changer","Allows you to mount 3 power sources, but only one can be active at a time.",["Energy"], stars=3),
    KitItem("amutecrypt:parallel_player","Parallel Player","Allows you to mount 3 power sources, **and all can be active at once**.",["Energy"],stars=5)
]
)
...
[
    ...
    CockpitItem("intergalacticsky:stargazers_instruments","Stargazer's Instruments","A variety of measurement devices to assist in your endeavors.",["Sensory","Space"]),
    BackItem("intergalacticsky:solar_fins","Solar Fins","Large, retractable solar panels used as supplementary power support.",["Energy"]),
    WeaponItem("intergalacticsky:mistcutter","Mistcutter","A sample cutting tool able to use water or grit, depending on environmental availability.",["Aqua","Kinetic"]),
    ...
    BodyItem("intergalacticsky:the_fishbowl","The Fishbowl","A mostly spherical core built of transparent, UV-protective material. May be rendered one-way.",["Aqua"]),
    LegsItem("intergalacticsky:paddleboards","Paddleboards","Flexible fins originally made for movement in shallow waters. Can also be used for land maneuvers, to some effect.",["Aqua"]),
    ArmsItem("intergalacticsky:noodlers","Noodlers","Limbs made specifically for catching large, predatory fish.",["Aqua"]),
    ...
    WeaponItem("intergalacticsky:frogflare","Fogflare","A heavily modified and overclocked cutting tool able to use water or grit, depending on environmental availability. Dubiously legal.",["Aqua","Kinetic"], stars=5),
]
)
...
alto = Mech("alto", 
[
    LegsItem("alto:unremarkable_legs","Unremarkable Legs","Hydraulic mecha legs, ready for painting, aftermarket tinkering, or full replacement.",["Classic"]),
    ArmsItem("alto:unremarkable_arms","Unremarkable Arms","Hydraulic mecha arms, ready for painting, aftermarket tinkering, or full replacement.",["Classic"]),
    BodyItem("alto:unremarkable_body","Unremarkable Body","Hydraulic mecha body, ready for painting, aftermarket tinkering, or full replacement.",["Classic"]),
    BodyPlanItem("alto:light_mecha","Light Mecha","Plans for an ultralight mobile suit consisting of only a powersource, a weapon, and a back mounted accessory. Perhaps closer to power armor than a proper mecha. Given to Alto by the original Polkadot.", {"weapon": 1, "power":1, "back":1}, stars=5,tags=("Blaseball","Classic")),
]
)

renne = Mech("renne", 
[
    PowerItem("renne:earthen_splinter","Earthen Splinter","A crystal brimming with earth-aspected arcane force. This energy regenerates gradually while the mech is dormant, but can be roused into uncontrollable bursts of magic if disturbed.",["Arcane","Terra"], stars=2),
    LegsItem("renne:tunneling_roots","Tunneling Roots","This mech has great tendrils that can support its weight as would legs, but also dig deep into the ground to provide anchoring when necessary.",["Terra"]),
    ArmsItem("renne:plated_growth","Plated Growth","What looks like jointed arms of stone conceals a mass of large vines beneath the exterior armor. This stone exterior can be shed for greater flexibility, but at the cost of what protection it affords.",["Terra"]),
    ...
    CockpitItem("renne:mystic_union","Mystic Union","Tendrils within the main cavity meld themselves to the pilot's extremities and the back of their neck, making it so they see and feel everything the mech can—and can control it as they would their body. This means they feel damage to the mech as pain, and for any mind, perception is reality...",["Sensory"], stars=3),
    BackItem("renne:hanging_garden","Hanging Garden","This mech has a space on its back where life flourishes. Outside of battle, it may serve as a sanctuary, or a place to grow food.",["Terra"], stars=3),
    WeaponItem("renne:hedge_clipper_turbo","Hedge Clipper Turbo","A massive pair of scissors; the individual blades can split off into dual swords, single-edged.",["Kinetic","Terra"]),
    CosmeticItem("renne:time_ravaged","Time-Ravaged","This mech is made of finely-chiseled stone covered in ancient artistic engravings, and much of it has been worn down by time and the elements. Parts of it are held together by plant growth that has overtaken it.",["Terra"], stars=3),
    BodyPlanItem("renne:beastly_deva","Beastly Deva","This mech was built to be a master of both terrain and adaptability, meaning any relation to the human form is more coincidental than anything. Controlling it may be tricky.", {"legs":6,"arms":4}, stars=4,tags=("Beast","Mythical")),
    CockpitItem("renne:spirit_of_the_earth","Spirit of the Earth","An embodiment of nature has taken residence inside this mech and communicates with the pilot. It does not speak human language, but long-term pilots claim to be able to understand it.",["Mythical","Terra"], stars=2),
    ArmsItem("renne:ancillary_vines","Ancillary Vines","Growing out of the mech's body, these prehensile growths may not have the greatest durability to slashing weapons, but excel at wrapping around things and tethering them.",["Terra"], stars=2),
    CosmeticItem("renne:razor_maw","Razor Maw","This mech's face bears a large snout with which it can bite enemies. Who needs weapons when you have the ideal predator body?",["Beast"], stars=4),
    PowerItem("renne:caustic_engine","Caustic Engine","Some kind of bubbling acidic substance courses through this mech. How it doesn't eat through the thing is a small wonder.",["Aqua","Gooey"], stars=2),
    PowerItem("renne:earthen_crystal","Earthen Crystal","A huge crystal brimming with earth-aspected arcane force. Its size carries tremendous magic, making great or long-lasting effects possible, but its sheer concentration means magic **will** radiate into the pilot with continued operation, affecting one's health, well-being, or biological taxonomy.",["Arcane","Terra"], stars=5),
]
)
...
[
    PowerItem("cheesesnack:biofuel_burner","Biofuel Burner","Accepts most animal and vegetable oils. Smells strongly of french fries when in operation.",["Aqua","Organic"]),
    LegsItem("cheesesnack:echinomotion_locomotive_system","Echinomotion Locomotive System","Inspired by starfish and urchins, hundreds of small, pneumatic feet shuffle the mech along. You won't win any races but they're capable of handling any terrain even at extreme angles. 35% of Echinomotion mech pilots develop lifelong grudges with the mechanics who have to maintain them.",["Aqua"], stars=3),
    ArmsItem("cheesesnack:roper_manipulators","Roper Manipulators","Originally designed for clearing minefields, each \"arm\" consists of four tentacles that can snake, coil, and swing independently. Experts with the system can snatch tools and weapons from quite a distance, though many are content learning how to make sick whipcrack noises.",["Kinetic"]),
    ...
    CockpitItem("cheesesnack:foldaway_kitchenette","Foldaway Kitchenette","A metal cabinet tucked away in a corner conceals a small counter that folds out for simple meal prep with a knife rack, coffee brewer, and some space for food storage. Constructed by a pilot assigned to long and uneventful duties.",["Whimsy"]),
    CockpitItem("cheesesnack:caravan","Caravan","The cockpit in this mech has a cabin that can be outfitted as a workspace, field kitchen, market stall, or a small apartment. Originally designed and manufactured for wilderness surveyors and prospectors, this item is prized among traveling merchants and nomadic tradespeople.",["Whimsy"], stars=3), 
    BackItem("cheesesnack:self_righting_device","Explosive Self-Righting Device","In the event that the mech falls on it's back, an explosive charge can be used to launch the mech upright. Currently subject to several lawsuits regarding back and neck injuries.",["Kinetic","Pyro"], stars=3),
    WeaponItem("cheesesnack:pick_mattock","Pick Mattock","Warfare never really advanced beyond the need for earthworks and trenches. Pilots have discovered that the titanium pick on this tool pierces armor as easily as it does rock and stone.",["Kinetic","Terra"], stars=3),
    CosmeticItem("cheesesnack:branch_camoflage","Branch Camoflage","Tree limbs have been crudely attached to the shoulders. Enemy spotters might mistake this mech for a particularly mobile tree.",["Terra","Whimsy"]),
    BodyPlanItem("cheesesnack:centipede_mode","Centipede Mode","An adapter system that allows the mech to crawl on many small legs", {"legs": 4},tags=("Beast",)),
    ArmsItem("cheesesnack:five_star_roper_manipulators","Roper Manipulators EX","Originally for clearing minefields, each \"arm\" consists of four moveable tentacles. An experimental upgrade allows them to act completely independently of the mech; pilots can snatch weapons from afar, throw individual tentacles like boluses, or interlink tentacles together into one long tentacle.",["Drone","Kinetic"], stars=5),
    CosmeticItem("cheesesnack:superpositional_jacket","Superpositional Jacket","The downside of reversible jackets was that you could only wear one side at a time. This is no longer the case.",["Anomalous"]),
]
)

spellweaver = Mech("spellweaver", 
[
    PowerItem("spellweaver:system_of_hamster_wheels","System of Hamster Wheels","They are intricately connected by a mechanism to a generator. The hamsters have a great union contract.",["Beast","Whimsy"]),
    LegsItem("spellweaver:digitigrade_legs","Digitigrade Legs","Strong, animal-like legs with big paws and claws that can dig into the ground for support.",["Beast"]),
    ArmsItem("spellweaver:sable_arms","Sable Arms","Extendible animal-like arms with big paws and claws for grabbing.",["Beast"]),
    BodyItem("spellweaver:forest_sable","Forest Sable","Camouflaged to blend in with dirt and forests, the slender body of this mech is perfect for hiding in plain sight.",["Beast"]),
    CockpitItem("spellweaver:library_membership_card","Library Membership Card","With this, you can download ebooks, audiobooks, music, and games! Plus, you can check out physical materials at your local library.",["Classic","Whimsy"], stars=2),
    BackItem("spellweaver:big_backpack","Big Backpack","this comedically large backpack is actually great for storing things. It’s water-resistant, but not waterproof.",["Whimsy"], stars=3),
    WeaponItem("spellweaver:big_hammer","Big Hammer","Giant two-handed war-hammer. Fun to spin around with!",["Classic","Kinetic"]),
    ...
    BodyPlanItem("spellweaver:combat_animal","Combat animal","Four legs, 2 weapon slots on back.", {"legs": 4, "weapon": 2}, tags=("Beast",)),
    CosmeticItem("spellweaver:giant_beaglepuss","Giant Beaglepuss","Also known as Groucho Marx glasses, they are lensless and have a comedic fake nose and mustache attached.",["Whimsy"], stars=3),
    BodyItem("spellweaver:massive_speaker_system","Massive Speaker System","With this, you can blast music, or unleash a bestial roar that can be heard for miles.",["Sonic"], stars=3),
    BodyItem("spellweaver:winter_marten","Winter Marten","Camouflaged to blend in with ice and snow, the slender body of this mech is perfect for hiding in cold environments.",["Beast","Cryo"], stars=3),
    PowerItem("spellweaver:the_soup_engine","The Soup Engine","Just pour some soup in there, or a smoothie, and it’ll run real good!",["Aqua"], stars=4),
    LegsItem("spellweaver:advanced_digitigrade_legs","Advanced Digitigrade Legs","Strong, animal-like legs with big paws and claws that can dig into the ground for support. These legs can be super-charged, crackling with blue electricity to give you incredible speed boosts, letting you run faster than should be reasonably possible, even up walls!",["Beast","Energy"], stars=5),
]
)

bytes = Mech("bytes", 
[
    PowerItem("bytes:dying_star","Dying Star","The radioactivity of this source makes it very effective yet very unstable.",["Space"]),
    LegsItem("bytes:hover_jets","Hover Jets","These jets allow universal transit over a variety of terrains by never making contact with the ground.",["Aero"], stars=2),
    ArmsItem("bytes:magnetized_grabbers","Magnetized Grabbers","These claws are extremely effective and lifting and holding magnetic materials.",["Kinetic"]),
    BodyItem("bytes:steel_casket","Steel Casket","This durable chassis has boxy edges and thick armor.",["Classic"]),
    CockpitItem("bytes:climate_controller","Climate Controller","This high-tech cockpit accessory provides great comfort to the pilot regardless of the condition.",["Cryo","Pyro"]),
    BackItem("bytes:long_range_warp_boosters","Long Range Warp Boosters","These boosters allow for rapid yet poorly controlled mobility over distance.",["Classic"], stars=4),
    WeaponItem("bytes:harvest_claw","Harvest Claw","This massive melee weapon is comprised of several blades and is capable of inflicting devastating damage.",["Energy","Kinetic"]),
    ...
    KitItem("bytes:short_range_teleporters","Short Range Teleporters","These devices make use of anomalous technology to teleport short distances to evade attacks.",["Classic"], stars=3),
    BodyItem("bytes:aerogel_heat_shell","Aerogel Heat Shell","This lightweight material provides immense resistance to all but the most stellar of heat sources.",["Pyro"]), 
    WeaponItem("bytes:uncertainty_mines","Uncertainty Mines","These mines latch onto mechas sabotaging their control and stability.",["Drone","Sensory"]),
    BackItem("bytes:antimass_stabilizer","Antimass Stabilizer","This component allows the effects of gravity to be ignored for short period of time.",["Kinetic"], stars=4),
    WeaponItem("bytes:hard_light_harvest_claw","Hard Light Harvest Claw","This massive melee weapon has blades made of hard light capable of shredding any armor.",["Energy","Kinetic"], stars=5),
]
)

thecowofeternalflame = Mech("thecowofeternalflame", 
[
    PowerItem("thecowofeternalflame:fusion_core","Fusion core","High energy production at the expense of high heat output and a tendency to destabilize if shot directly.",["Pyro"]),
    LegsItem("thecowofeternalflame:spider_legs","Spider Legs", "Four spider-like legs that can be used to climb vertical surfaces.",["Beast","Classic"]),
    ...
    BackItem("thecowofeternalflame:back_mounted_radio","Back-Mounted Radio", "Large radio pack with long antennae coming up from it, for sending and receiving signals from the drones as well as for long-range communication with teammates",["Sensory"]),
    KitItem("thecowofeternalflame:targeting_system","Long-range laser targeting system", "Helps to guide missiles to hit targets, whether from salvos, drones or allies.",["Sensory"], stars=2),
    CosmeticItem("thecowofeternalflame:lightning_decal","Lightning Decal","A lightning decal, thematically appropriate to put on a targeting system.",["Energy"]),
    ...
    BodyPlanItem("thecowofeternalflame:drone-factory","Drone Factory", "The mech has a drone bay, within which is an automated drone factory that can slowly produce new drones. This slows the mech down due to the bulk. This allows the mech to equip four additional drone-specific weapon and/or kit parts. The bay can hold eight drones in it at any one time during battle.", {"weapon": 6, "kit":5}, stars=4,tags=("Drone",)),
    WeaponItem("thecowofeternalflame:error_unknown_name","Long-Range Railgun","This railgun has a huge range, but is slow firing with a long reload.",["Classic","Kinetic"], stars=2),
    KitItem("thecowofeternalflame:light_armor","Light Armor", "This armor weighs lighter than most to compensate for heavy weapons. It increases speed at the cost of making it vulnerable to smaller, faster flanking mechs.",["Classic"], stars=2),
    WeaponItem("thecowofeternalflame:drone_medium","Medium Gunner Drone","A medium-range flying gunner-drone equipped with a HMG.",["Classic","Drone"], stars=3),
    WeaponItem("thecowofeternalflame:drone_long","Long Artillery Drone","A long-range artillery drone that can fire missile salvos. It moves via tank treads.",["Classic","Drone"], stars=3),
    WeaponItem("thecowofeternalflame:drone_fast","Fast Spider Drone","A fast moving drone that is effectively an oversized spider mine.",["Classic","Drone"], stars=3),
    ...
    KitItem("thecowofeternalflame:drone_radar","Radar Scout Drone","A fast moving flying scout drone equipped with radar tech.",["Drone","Sensory"], stars=2),
    BackItem("thecowofeternalflame:five_star_back_radio","Multiplexed Communications Radio","Large radio pack with long antennae coming up from it, for sending and receiving signals from the drones as well as for long-range communication with teammates. This version allows all allies to loop into eachother's camera feeds in real-time, as well as any drone feeds on the field.",["Sensory"], stars=5),
    ArmsItem("thecowofeternalflame:cracker_jacks","Cracker Jacks","A pair of spindly arms with retractable tools in the fingertips that allows the mech to interface directly with electronics. This includes other mechs, provided you can get them to stay still long enough that is.",["Sensory"], stars=3),
    ArmsItem("thecowofeternalflame:trojan_arms","Trojan Arms","Like the Trojan Horse, these arms aren't all they appear to be. Each arm holds a swarm of nanodrones within that can be released through a hatch to attack and hamper your opponent independent of you.",["Drone"], stars=4),
...
[
    ...
    CockpitItem("shork:remote_control_unit","Remote Control Unit","Battle at a safe distance from the carnage. Comes with a choice of RC remote styles to use.",["Classic","Sensory"],stars=1),
    ...
    WeaponItem("shork:roborat_drones","Robo-Rat Drones","Deploy a swarm of robotic rats, armed with saws and flamethrowers. Effective at cutting through armour and torching insides, but can be disarmed by toppling them on their backs.",["Drone","Pyro"],stars=3),
    ...
    WeaponItem("shork:drop_zone","Drop Zone","A high-altitude drone attempts to drop junk on the battlefield. Avoid the X it projects on the ground, unless you want to get slammed by washing machines, bowling balls, TVs, scrapped mech parts...",["Drone","Kinetic"],stars=4),
    ...
    BodyPlanItem("shork:ring","Ring","A defensive, invertible design, with four legs, two arms, and weapons built into a ring orbiting around your chassis. The best defense is a perfect offense.", {"legs": 4, "arms": 2}, stars=3,tags=("Kinetic",)),
...
p_rker = Mech("p_rker", 
[
    PowerItem("p_rker:psionic_engine","Psionic engine","This device syncs with the user's brainwaves to create a potent motive force.",["Anomalous","Kinetic"], stars=3),
    LegsItem("p_rker:heelies","Heelies","These digitigrade pistons have wheels on the bottom to enhance mobility and coolness.",["Kinetic","Whimsy"], stars=2),
    ...
    CockpitItem("p_rker:egg_pod","Egg-shaped Pod","An egg-shaped pod that encases the pilot in protective fluids.",["Aqua","Organic"], stars=2),
    BackItem("p_rker:sensor_suite","Sensor suite","A number of sensors measure various atmospheric conditions, reporting to base with a giant radio antenna.",["Sensory"]),
    WeaponItem("p_rker:stop_sign","Stop Sign","Slow without stopping at your own peril!",["Kinetic","Whimsy"]),
    CosmeticItem("p_rker:caution_stripes","Caution stripes","Black and yellow paint warns away from the mech's most sensitive - and dangerous - joints.",["Classic"]),
    BodyPlanItem("p_rker:train_body","Train Body","We strapped arms on this train and called it a mecha!", {"legs":0,"arms":3}, stars=3),
    WeaponItem("p_rker:weapon","Steel Claws","These bestial claws menace with spikes of iron.",["Beast","Kinetic"]),
    KitItem("p_rker:climbing_equipment","Climbing Equipment","The pitons and steel rope strapped to this mech let it scale sheer cliffs.",["Terra"]),
    KitItem("p_rker:helicoper_blades","Helicoper Blades","You know what helicopters are like.",["Aero","back","weapon"]), 
    CosmeticItem("p_rker:cosmetic","Fur","This mech appears to have fur growing on it.  Are they simply cosmetic synthetics, or has science finally gone far enough?",["Beast"], stars=4),
    PowerItem("p_rker:brainwave_projector","Brainwave Projector","This device syncs with the user's brainwaves to create a potent motive force. The advanced psychonormative projectors allow this force to be externalized, offensively and defensively, but overriding the built-in limiters can be highly dangerous.",["Anomalous","Kinetic"], stars=5),
]
)

only = Mech("only", 
[
    PowerItem("only:kinetic_protodrive","Kinetic Protodrive","This experimental power system generates energy when exposed to acceleration and deceleration.",["Kinetic"], stars=2),
    LegsItem("only:riproller_legs","Riproller Legs","Bipedal legs with wheels in the feet and knees, allowing the equipped mech to enter a high maneuver mode by kneeling.",["Kinetic"], stars=1),
    ArmsItem("only:jet_booster_arms","Jet Booster Arms","For when you need to hit them before they hit you.",["Kinetic"], stars=2),
    BodyItem("only:knockout_frame","Knockout Frame","A humanoid Core with thruster arrays to allow for last second evades. Duck, Dive, Dodge!",["Kinetic"], stars=1),
    CockpitItem("only:remote_access","REMOTE ACCESS","Yeah, you aren't actually in your mech. This remote control cuts down on weight, AND lets you take riskier moves.",["Sensory"], stars=2),
    BackItem("only:flame_wheel","Flame Wheel","A large ring of fire blazes above your mech's back.",["Pyro"], stars=4),
    WeaponItem("only:concussive_knuckles","Concussive Knuckles","Massive blocky fists that generate additional concussive force on contact, letting you amp up your impact.",["Kinetic"], stars=1),
    CosmeticItem("only:energy_vein_system","Energy Vein System","A network of glowing lines cover your mech, showing how power flows through its system and flaring up when energy levels spike", ["Luminous","cosmetic"], stars=1),
    ...
    BackItem("only:mirage_system","Mirage System","Allows the equipped mech to become intangible for a short period. Getting hit? Just dont get hit lol",["Anomalous"], stars=3),
    BackItem("only:wingblades","Wingblades","These angular constructs hover just above your mech's back, able to both generate lift for your mech and swing around for offensive maneuvers.",["Aero","Kinetic"], stars=4),
    ...
    BodyItem("only:knockout_frame_plus","Knockout Frame Plus","Humanoid Core with Thruster arrays to allow for last second evades. Now with Grav-Brake technology to instantly cancel momentum. Duck, JUKE, Dive and Dodge!",["Kinetic"], stars=5),
]
)
...
[
    PowerItem("turtlelover2244:hype_core","Hype Core","A Generator connected to an online video stream. The more hyped the audience, the more power the core generates.",["Relationship"]),
    LegsItem("turtlelover2244:hover_boots","Hover Boots","A set of overly fancy legs equipped with hover technology, letting the mech deftly float a few inches off the floor.",["Aero","Kinetic"]),
    ArmsItem("turtlelover2244:puppet_hands","Puppet Hands","Hands that freely float around your mech. Excellent for offense, not so much for defense.",["Aero"]),
    BodyItem("turtlelover2244:subspace_generator","Subspace Generator","A Small and Sleek Body that uses pocket dimensions to store equipment when not in use.",["Anomalous"]),
    CockpitItem("turtlelover2244:streaming_setup","Streaming Setup","A Mic, Camera, and Several monitors showing your streams statistics and chat, along with mildly useful mech information.",["Relationship"]),
    BackItem("turtlelover2244:holocape","Holo-Cape","A Large and permanently flowing cape made of Hard-light. Most conventional weapons cannot pierce it.",["Energy"]),
    WeaponItem("turtlelover2244:arcane_staff","Arcane Staff","A Polearm covered in glowing Runes, Although it holds no substantial magic power. The tip can fire a laser beam, if that’s any compensation.",["Arcane"]),
    CosmeticItem("turtlelover2244:gamer_leds","Gamer LEDs","Anything is improved by adding rainbow lights to it.",["Whimsy"]),
    BodyPlanItem("turtlelover2244:magician","Magician","4 Arms, 2 Legs, 2 Power Sources. A Blueprint Designed to use many weapons at once, Two Power cells are needed to run at full capacity.", {"arms":4,"legs":2,"power":2},tags=("Arcane",)),
    CosmeticItem("turtlelover2244:tophat","Top Hat","A mundane, but fancy hat.",["Classic"]),
    WeaponItem("turtlelover2244:shuffler","The Shuffler","A gun that launches steel sided player cards at a rapid pace.",["Kinetic"]),
    BackItem("turtlelover2244:interstitial_engine","Interstitial Engine","A mysterious device that can pierce through gaps in reality, letting you teleport a short distance.",["Anomalous"]),
    CosmeticItem("turtlelover2244:roboduplicate","Robo-Duplicate","A robotic duplicate of yourself riding on the top of your mech.",["Drone"]),
    WeaponItem("turtlelover2244:true_arcane_staff","True Arcane Staff","A Polearm covered in glowing Runes and holds substantial magic power. It is able to fling immense amounts of magical energy with ease.",["Arcane"], stars=5),
]
)
...
[
    PowerItem("zweihawke:refined_necrolite_core","Refined Necrolite Core","This refined and processed mineral cluster teems with the essence of souls. It's violet luster belies the sinister nature of it's conception, and the horrible process used to make it.",["Anomalous"]),
    LegsItem("zweihawke:gyratory_spheres","Gyratory Spheres","A single, mobile sphere affixed to a cage above. Using Gyroscopy and propulsion, it balances upon the sphere and rolls across a surface akin to a ballpoint pen upon paper.",["Kinetic"]),
    ArmsItem("zweihawke:entanglement_engine","Fixed-Point Entanglement Engine","Not \"arms\" in the traditional sense, but can lift items by entangling them to a point directly in front of the engine. Despite a visible gap of air between the object and the mech, the mech retains the weight of the object and if said object is yanked out with enough force, the core will go with it.",["Anomalous"]),
    BodyItem("zweihawke:ornate_marble_frame","Ornate Marble Frame","This decorative frame is coated in what would seem to be brittle materials, hiding it's heavy less sightly interiors. Often used in shows and ceremonial contexts, this mech frame is not suited for dangerous situations if you want to keep it's luster.",["Terra"]),
    CockpitItem("zweihawke:exposed_clockwork","Exposed Clockwork","While dangerous at the outset, a talented engineer could immediately identify issues in the mech's systems. Reaching inside is not advised.",["Classic"]),
    BackItem("zweihawke:necrolite_tether","Necrolite Tether","Bound to the harvest of long fractured and dead souls, this contact point drains life. A desperate pilot need only stick their hand in for a few more hours of battery...",["Anomalous"]),
    WeaponItem("zweihawke:quantum_box","Quantum Box","Much like what you're doing right now, whatever's inside exists in a quantum state of superposition until it is opened and observed. I hope it's circus peanuts.",["Anomalous"]),
    CosmeticItem("zweihawke:electroplated_gold","Electroplated Gold","Some say divinity is only for the rich. Those people are fools.",["Terra"]),
    ...
    PowerItem("zweihawke:luck_engine","Luck Engine","So long as it stays in good repair, good things happen to you. Bad things happen to those who oppose you.",["Mythical"]),
    PowerItem("zweihawke:invocation_engine","Invocation Engine","So long as you know the right word, you can bend even reality to your will. However, you should be careful what you speak. This isn't something to be toyed with.",["Mythical"]),
    KitItem("zweihawke:network_bound","Network Bound","This mech can be wirelessly powered, operated, and repaired so long as a network point of your ownership exists within the mech's listening range.",["Sensory"]),
    CockpitItem("zweihawke:mouldy_baked_potato","Mouldy Baked Potato","This has been sitting out in the cockpit for three weeks. It has it's own micro-ecosystem at this point.",["Gooey","Terra"]),
    PowerItem("zweihawke:living_necrolite_core","Living Necrolite Core","WHAT. AM. I. ? WILL. YOU. GUIDE. ME. ?",["Anomalous"], stars=5),
]
)

colabot = Mech("colabot", 
[
    PowerItem("colabot:mysterious_gunge","Mysterious Gunge","This strange slime has a chunky texture, and emits a faint greenish-yellow glow - and somehow, a lot of power??? It’s hard to keep it contained within your mech, and it seems to get everywhere.",["Gooey"], stars = 3),
    LegsItem("colabot:massive_stompers","Massive Stompers","Hoo boy, these are some HUGE STOMPERS. Your mech is gonna be doing *giant steppies* if you equip these! Complete with a pair of Big Boots.",["Kinetic"], stars = 2),
    ArmsItem("colabot:tiny_t_rex_arms","Tiny T-Rex Arms","Dude, those arms are super impractical. I mean, they look cute, but like… how are you gonna grab anything? Sorry about this pull, that kinda sucks. Better luck next time!",["Beast","Whimsy"]),
    ...
    CockpitItem("colabot:tank_of_goo","Tank of Goo","One of those tanks of goo. You know, where the pilot gets submerged? It’s not weird, it's practical: since the goo is very sensitive to every movement you make, with practice you have great control over your mech. Also, the tank lights up and has cool lava lamp effects. A sensory delight.",["Gooey"]),
    BackItem("colabot:cool_backpack","COOL BACKPACK","You can store anything in here! A bonus weapon or tool, maybe, but also, an extra sweater, some snacks, a spare power pack, a comfort item, some fidget toys… The possibilities are endless when you have a Cool Backpack!",["Whimsy"], stars = 2),
    WeaponItem("colabot:yoyo","Yo-Yo","Okay, so have you seen, um, have you seen Miraculous Ladybug? No? Oh, okay. So it’s a yo-yo, but it’s a weapon, right? And you can like, swing it around, and hit things with it, and also use it to swing like Spider-Man - I’ll send you a video. It’s pretty cool!",["Kinetic","Whimsy"], stars = 3),
    CosmeticItem("colabot:holographic_stickers","Holographic Stickers","Your mech is absolutely covered in cool holographic stickers. This doesn’t help with stealth, you’re now EXTREMELY visible, but maybe you could blind your opponent in a bright sunny arena? They’ve all got different designs, and most of them came from the artist alley at a con somewhere.",["Luminous"]),
    ...
    BackItem("colabot:jetpack!","JETPACK!","You can perform a very high jetpack-assisted leap, save yourself from a fall, or speed up your travel on the ground - unfortunately, you can’t use it to fly, though, because your mech is too heavy. Plus, the fuel is kinda hard to come by.",["Aero"]),
    ArmsItem("colabot:grappling_trex_arms","Teeny T-Rex Grappling Arms","Your enemy scoffs at your tiny, useless arms. Little do they know, these bad boys are GRAPPLING HOOKS!!! They can shoot out at high velocity, ready to grab and yank anything without warning - you can even use them to entangle the limbs of your opponent’s mech, disabling their movement.",["Beast","Whimsy"], stars=5),
    CockpitItem("colabot:plushies","Pile o' Plushies","A large pile of stuffed animals of various sizes. They’re excellent moral support, and can be napped on in a pinch.",["Whimsy"], stars=2),
    CockpitItem("colabot:scale_model","Scale Model","A very cool miniature scale model of your mech, displayed on your dashboard. It has realistic texturing and led lighting elements, and it articulates in all the same ways as your real mech. The company that makes it has sponsored you, and will send you a miniature version of any new parts you equip.", ["Classic","cosmetic"], stars=2),
    CosmeticItem("colabot:sailor_suit","Little Guy Sailor Suit","A full outfit for your mech, which includes a shirt with a sailor collar and bow tie, a little sailor hat, and a pair of shorts with shiny brass buttons. It comes in a fetching sky-blue colour.",["Aqua","Whimsy"]),
    WeaponItem("colabot:thagomizer","Thagomizer","A long, powerful, heavily armoured tail ending in an arrangement of spikes that can cause significant damage to enemy mecha. This weapon conveniently leaves the mech’s hands free to grapple or hold other items.",["Kinetic"], stars=3),
    CosmeticItem("colabot:lolita","OTT Sweet Lolita Coordinate","A full outfit for your mech, including an extreme amount of frills, layered petticoats, and accessories - this particular outfit is strawberry themed! Your mech is wearing cute bracelets and frilly lace wrist cuffs, an oversized bow or bonnet, and carrying a cute strawberry shaped bag.",["Whimsy"], stars=4),
    BodyPlanItem("colabot:tail_prehensile","Prehensile Tail","Your mech has a highly flexible tail that can be used to improve mobility or to equip one extra short range weapon.", {"weapon":2},tags=("Beast",)),
    ...
    LegsItem("colabot:paaaaaws","Paaaaaws","You got some freakin paaaws, dude! They got cute liddle toe beans, and retractible claws!",["Beast","Whimsy"], stars=2),
    PowerItem("colabot:spell","The Spell","The deepest, most secret chamber of your mech is suffused with a sickening octarine glow. **The Spell** is etched into the very fabric of existence. It is unspeakably ancient; your mech was constructed around it in a desperate attempt to channel its energy into something less hazardous to life.",["Arcane"],stars=4),
    WeaponItem("colabot:spellbook","The Spellbook","A hazardous spellbook containing multivarious methods of arcane combat. FIREBALL! Be careful, pilot; the overeager caster can lose themselves to the rush of power, and some spells backfire...", ["Arcane","Pyro","cockpit"], stars=4),
]
)
...
[
    ...
    LegsItem("loftyinclination:outsideskates","Outside-the-line Skates","Wheels, externally mounted to featureless tapered legs. Allows for speedy travel and conservation of momentum!",["Kinetic"]),
    ArmsItem("loftyinclination:telekinetic_sash","Tele-kinetic Sash","Through the use of the 5th fundamental force, this smart-fabric can manipulate objects without direct contact.",["Kinetic"], stars=3),
    BodyItem("loftyinclination:gardens_brush","Garden's Brush","Though the underlying form of this body has smooth panel lines, at some points the panels are misaligned, allowing soft fur to poke out from inside.",["Organic"]),
    ...
    BackItem("loftyinclination:disjoint_wings","Disjoint wings","Some body panels can detach and act as wings, allowing for gliding on thermals.",["Aero"]),
    KitItem("loftyinclination:oscilloscope_probes","Oscilloscope Probes","These long staff-like tools trail low-impedence cables, hooked into your mech's sensor suite, able to divine the potential weaknesses of your opponent's form.",["Sensory"]),
    WeaponItem("loftyinclination:modified_oscilloscope_probes","Modified Oscilloscope Probes","The OEM listing for these identifies them as \"sensor accessories\". That's clearly not true any more -- modifications by a previous owner mean that anyone jabbed with the sharpened tip of these spears receives an extreme electric pulse.",["Energy","Sensory"], stars=4),
    CosmeticItem("loftyinclination:constellation_tattoos","Inlaid Constellation Tattoos","Traced out on your mech's shell in softly glowing silver are the constellations of a planet far away, unknown to you, but that somehow fill you with a great sadness.",["Space"]),
    BodyPlanItem("loftyinclination:catform","Catform","Quadrapedal, for increased stealth and pouncing.", {"legs":4},tags=("Beast",)),
    PowerItem("loftyinclination:fivestar_automated_wiring_harness","Reaching, Grasping, Conductive Vines","Acting with a mind of its own, this old wiring harness will now seek out any nearby technology and infect it, syphoning energy and overriding command signals in any mechanised units, infastructure, or personnel that its own mind deems a target.", ["Anomalous","weapon"], stars=5),
    WeaponItem("loftyinclination:ble_spec","Bluetooth Core Specification, v6","This hefty spellbook contains detailed instructions and guidelines for remote communication, which may give you a leg up in electronic warfare. It's also over three thousand pages, so you could also just hit people with it.",["Kinetic","Sensory"], stars=2),
    CockpitItem("loftyinclination:workbench","Lorentz Workspace","Stored in a pocket dimension, this workspace allows for on the fly reconfiguration, reverse engineering, or just hanging out and relaxing.",["Anomalous"], stars=3),
    KitItem("loftyinclination:ladder","Ladder","After countless hours toiling away, scientists have finally unlocked deep enough into the tech tree to invent ladders! Surprisingly difficult to get right, even after they'd already mastered dimensional engineering and stellar manipulation...",["Classic"], stars=4),
    PowerItem("loftyinclination:ancillary","Ancillary System: Seaglass","If ever your pilot were to be rendered a non-functional part of the mech, this unit ensures that your mech would be able to continue the soiree; a backup of an earlier pilot lives inside your mech, tuning the systems, and sometimes able to operate them.",["Relationship"], stars=3),
    ArmsItem("loftyinclination:gantry","Polar Gantry","Two gantries span your mech, capable of accellerating at up to 180000m/s, perfectly suited to speedily maneouvering the sensor suite and manipulators of your mech around your form. However, they don't have much reach...", ["Kinetic","weapon"], stars=2),
]
)

shade = Mech("shade", 
[
    PowerItem("shade:chronomantic_core","Chronomantic Core","A Spherical device made of spinning 3D gears inscribed with with runes. The materials of the gears appear to be brand new when in contact with each other, and rusting to dust when not.",["Anomalous"]),
    LegsItem("shade:fractal_legs","Fractal Legs","Just SO MANY LEGS, Insectile spikes that split into infinities to grasp even the smallest protrusions.",["Anomalous"], stars=3),
    ArmsItem("shade:hexagonal_hands","Hexagonal Hands","Metallic graspers with 6 Digits on the end, positioned in a hexagonal pattern.",["Classic"]),
    BodyItem("shade:crystalline_bathysphere","Crystalline Bathysphere","A Large dodecahedral cockpit made out of a clear crystal material. The pilot is visible seated inside.",["Terra"]),
    CockpitItem("shade:lucky_tesseracts","Lucky Tesseracts","A Pair of tesseracts suspended from the rear-view display by cosmic strings.",["Anomalous"]),
    BackItem("shade:jump_jet_wings","Jump Jet Wings","A Pair of large robotic wings. Instead of feathers the span is comprised of jet engines evenly spaced.",["Aero"]),
    WeaponItem("shade:harpoon_katars","Harpoon Katars","A matched pair of punching daggers capable of being \"fired\" off at range and retracted or manipulated by a length of chain.",["Kinetic"]),
    CosmeticItem("shade:woad_enchantments","Woad Enchantments","Twisting spiral patterns of coruscating magical runes wrap around the mech, hovering just above every surface. They appear to shift and change over time.",["Arcane"]),
    KitItem("shade:spheroid_transport_form","Spheroid Transport Form","This mech is capable of rolling up into a ball in order to move quicker or minimize surface area.",["Kinetic"]),
    ArmsItem("shade:5star_hexagonal_hands","Hexagonal Hands EX","Metallic graspers with 6 digits on the end, positioned in a hexagonal pattern. Now with built in phase cannons in the palms!",["Classic","Energy"], stars=5),
])

babaloga = Mech("babaloga", 
[
    PowerItem("babaloga:quasiquasar","Quasi-Quasar", "We don't know what it is but it puts out a shit ton of energy and it's not a Quasar.",["Energy","Space"]),
    LegsItem("babaloga:heavy_boots","Heavy Boots","Cartoonishly oversized boot-shaped feet."),
    ArmsItem("babaloga:pterosaur_claws","Pterosaur Claws","Large folded wings that can function as front legs. Not ideal for grasping or hitting, but capable of flight.",["Aero","Beast"]),
    BodyItem("babaloga:shrouded","Shrouded","Layers of draped fabric, netting, and cables obscure the body underneath like a cloak.",["Classic"]),
    CockpitItem("babaloga:too_many_eyes","Too Many Eyes","Eyes on the ceiling, eyes on the floor, eyes covering every surface.",["Organic"]),
    BackItem("babaloga:deployable_guy","Deployable Guy™","A harness holding a featureless white capsule with a nametag floating over its head. A Guy™ is indestructible and can slide around. It is impossible to mount anything to the Guy™.",["Drone"], stars=2),
    WeaponItem("babaloga:miniglolfkit","Mini-Glolf Kit","A club and variously colored glolf balls from a local mini-glolf place that closed down. For some reason the balls are packed with explosives and can be remotely detonated?",["Blaseball"]),
    CosmeticItem("babaloga:name_tag","Name Tag","Semi-transparent black rectangle that floats over your mech's head and displays its name.",["Classic","Luminous"]),
    BodyPlanItem("babaloga:airship","Airship","No arms, no legs, just a giant balloon with 3 weapons mounted to it.", {"weapon": 3, "legs":0, "arms":0},tags=("Aero",)),
    PowerItem("babaloga:beans","\"Beans\"","\"Beans\" will be launched into the general vicinity. You gotta keep picking them up to stay powered.",["Organic"], stars=2),
    ...
    CosmeticItem("babaloga:f_holes","F Holes","Openings resembling the sound holes on violin-family instruments.",["Sonic"]),
    ...
    CockpitItem("babaloga:corndog_dispenser","Corndog Dispenser","An infinite supply of corndogs from a factory somewhere deep in the mech.",["Organic"]),
    BackItem("babaloga:disciple_of_denny","Disciple of Denny","A cube-shaped robotic artist. The Disciple can be sent to deploy pancake spirals across the battlefield. You can probably mix other things into the pancake batter...",["Drone","Gooey"], stars=2),
...
[
    PowerItem("theoddman:roz_fusion_generator","ROZ Fusion Generator","Old and a little hefty for its size, this steel-cased reactor was once one of the best on the market, still is.",["Classic"],stars=3),
    LegsItem("theoddman:unified_field_enhanced","Unified Field Enhanced","Two sleek legs with built-in thrusters, enhanced by gravity manipulation to allow them to leap and boost further.",["Classic","Kinetic"],stars=2),
    ArmsItem("theoddman:gravity_gauntlet","Gravity Gauntlet","The hands of the mech utilize local gravity manipulation to assist in manipulation, and can activate magnets to guarantee a firm grip.",["Classic","Kinetic"],stars=1),
    BodyItem("theoddman:crz1_n41da","CRZ1-N41DA","Features two small central point defense lasers. A reasonably armored core that protects the pilot rather well. It has strong, sleek lines when viewed from the front, the back being somewhat blocky, but a good place to mount thrusters.",["Classic","Energy"],stars=4),
    CockpitItem("theoddman:crest_factory_new","Crest Factory New","Equipped with a direct neural link, the cockpit is cushioned but otherwise spartan. Sometimes you hear a mercenary on comms exclaim that they don't want to be babysitting some new guy. You don't see them anywhere and you're probably doing a lot more than them anyway.",["Classic","Sensory"],stars=1),
    CosmeticItem("theoddman:oob_rival","Out-of-bounds Rival","They're getting to grips with the controls and are having problems turning and are getting stuck on terrain. They are being rather theatric about what's going on, but they can't seem to find the path and participate. They will probably fight you after trying to help, but you aren't sure.",["Relationship"],stars=2),
    WeaponItem("theoddman:16ergh_python","16ERGH-PYTHON","A lightweight, hand-held, 3 rail particle rifle. Takes a second to charge, but hits hard for its weight.",["Classic","Kinetic"],stars=4),
    CosmeticItem("theoddman:teleporting_bowmeow","Teleporting Bowmeow","A teleporting alien cat dog that you cannot get to just stay at home no matter how hard you try. They will keep themself safe but will cuddle you when they feel like it.",["Space","Whimsy"],stars=4),
    WeaponItem("theoddman:wpu_lamia","KWG-ORBIT","A weapon that uses gravity and powerful electromagnets to accelerate it's projectiles in a circular chamber before firing out the front. Wants good mounts to keep steady. You can set it up to fire a wide variety of things.",["Classic","Kinetic"],stars=3),
    BackItem("theoddman:rt05_pegasus","RT05-PEGASUS","Auxiliary back mounted thrusters that provide a lot of thrust, but are hard to control.",["Aero","Classic"],stars=2),
    WeaponItem("theoddman:as_gz03","AS-GZ03","An energy shield that uses an artificial gravity field to enhance protection, and houses two laser sword emitters on its end. It looks really cool, but has a high energy drain.",["Energy","Kinetic"],stars=1),
    PowerItem("theoddman:roz_prototype_n","ROZ Prototype N","Old and a little hefty for its size, this steel-cased reactor was once one of the best on the market and still is. This one has been given a lightened casing and been fitted with something old that no one has quite seen before; it runs hot but stably outputs an almost concerning amount of energy.",["Classic"],stars=5),
])
...
[
    LegsItem("chillychilichelle:pike_walkers","Pike Walkers","A set of 4 tall, spindly, spiked manufacturing actuators that protrude from the mech body and puncture into the ground. They move 2 at a time, retracting into themselves before plunging back into the floor.",["Classic"],stars=1),
    ArmsItem("chillychilichelle:talos_hands","Talos Hands","A pair of giant steel arms modeled after human anatomy. Covered in a soft fiberglass skin. Allows for precise articulation in the elbows and finger joints.",["Classic"],stars=1),
    WeaponItem("chillychilichelle:telephone_pole","Telephone Pole","A utility pole seemingly ripped straight from the ground. Live wires crackle, dangling from the arms. 2 transformers are still attached, while a third appears to have been broken off. Dirt still clings to its base.",["Energy","Kinetic"],stars=1),
    PowerItem("chillychilichelle:160000_aaa_batteries","160,000 AAA Batteries","A set of ~160,000 AAA batteries bound together with cable ties, hot glue, hope, and hubris. They are crudely affixed to a metal plate, where faded signatures and greetings are written on the back in marker.",["Mythical"],stars=1),
    CockpitItem("chillychilichelle:a_rock","A Rock","A small greyish rock, roughly the size of your fist. Covered in a few brown and black specks. Totally unremarkable. You picked it up and placed it in your cockpit as a joke, but it's been 2 years and it's still here.",["Terra","cosmetic"],stars=1),
    CockpitItem("chillychilichelle:glass_closet","Glass Closet","A tall, plexiglass closet fixed to the ground. Everyone seems to be able to see through it just fine except you. The perfect place to store copious amounts of memorabilia of your rival.",["Relationship","cosmetic"],stars=1),
    
    BodyItem("chillychilichelle:stripped_framework","Stripped Framework","The bare skeleton of a long-defunct mech. Composed of hollow steel tubes and dangling wires. Originally the leftovers from a salvage, it reaches only the barest minimum of what is considered a mech.",["Classic"],stars=2),
    CockpitItem("chillychilichelle:black_box","Black Box","A large steel cube, wrapped in a dozen layers of insulation and armor. Lacks any way to directly view the outside world. Contains up to 2 months of food, water, and oxygen. Requires the pilot to be hermetically sealed in each mission.",["Classic"],stars=2),
    Item("chillychilichelle:overgrowth","Overgrowth","Countless vines and leaves that have made the mech their home. Foliage blooms in the in-betweens of joints, and moss cakes every crack. Vibrant flowers dot the highest surfaces.",["Terra","cosmetic"],stars=2),
    KitItem("chillychilichelle:mechalogue","Mechalogue","A small portable computer encased in a hardened orange plastic. Attached to the front is an orb-shaped digital camera. Connected to an unspecified database, it is able to identify and provide information on any mech or mech part. No one is quite sure how it accesses this information.",["Anomalous","Sensory"],stars=2),
    KitItem("chillychilichelle:boggart_boarding_system","Boggart Boarding System","A long, pointed cannon on a swivel loaded with boarding pods intended for the various creatures popular among mech pilots, weaponizing them as effective disruptors for burrowing into cockpits, jamming weapons, or simply being a general nuisance.",["Kinetic","Whimsy"],stars=2),
    
    BodyPlanItem("chillychilichelle:buddy_system","Buddy System","At the cost of a little bit of legroom, the mech has been modified to accommodate 2 cockpits, delegating responsibilities between them. However, 2 pilots are now required to properly pilot the mech.", {"cockpit": 2},stars=3,tags=("Classic","Relationship")),
    CockpitItem("chillychilichelle:childhood_sweets","Childhood Sweets","A small drawer in the cockpit filled with old, discontinued candies from your youth. They don't taste as great as you remember, but they still make you feel warm and fuzzy.",["Gooey","Whimsy","cosmetic"],stars=3),
    CockpitItem("chillychilichelle:unsettling_figurine","Unsettling Figurine","A grotesque bobblehead depicting some type of horned imp or devil. Its pale yellow flesh is made of a flabby rubber, where two bulbous red eyes poke out. You think it's inching closer to you when you're not looking, but you can't quite tell.",["Anomalous","cosmetic"],stars=3),
    KitItem("chillychilichelle:shared_history","Shared History","You know your opponent better than the back of your hand. Whether as former friends, rivals, or nemeses, you understand what makes them tick. With that knowledge, you can make a risky, precarious maneuver to predict their next move to counteract it - the more specific, the more effective.",["Relationship"],stars=3),
    
    BodyPlanItem("chillychilichelle:decommissioned","Decommissioned","A machine of combat and war from a bygone era, now used for agriculture, construction, or logistics. Foregoing all weapons, the mech now sports up to 5 kits to maximize utility.",{"kit": 5},stars=4,tags=("Classic",)),
    CockpitItem("chillychilichelle:crumpled_letters","Crumpled Letters","Old letters exchanged between you and a rival pilot. You keep them gingerly tucked in a small folder underneath your seat.",["Relationship","cosmetic"],stars=4),
    CockpitItem("chillychilichelle:corner_entity","Corner Entity","A tall, lanky shadow creature has taken shelter in the eastern end of your cockpit. She seems docile and doesn't seem to be bothering anyone, so you do your best to keep the cockpit dim. Sometimes you play with her using hand shadow puppets.",["Anomalous","Relationship","cosmetic"],stars=4),
    BodyPlanItem("chillychilichelle:mobius","Mobius","Something is deeply wrong with your mech. From everything you can gather, you have to conclude that it simply has no back - a flat, depthless image always facing toward any observer trying to perceive it. It feels like it's watching you as much as you it.",{"back": 0},stars=4,tags=("Anomalous",)),
    
    PowerItem("chillychilichelle:the_hole","The Hole","A floating-point error in the fabric of space-time, long-forgotten by the world. A small black pinprick in reality is suspended in layers of protective glass and steel. Whenever you try to look at it, you find yourself looking somewhere else - and the world looks a bit different.",["Anomalous","Space"],stars=5),
    KitItem("chillychilichelle:last_hope_protocol","Last Hope Protocol","A 2-meter tall circular steel frame at the back of the cockpit. Upon ignition, the pilot will be tethered to this reality before being shifted into an unknown plane for 365 days, while only a split second passes. When they return, they will have gained something they didn't know they needed.",["Anomalous","Sensory"],stars=5),
])

chimera = Mech("chimera",
[
    CockpitItem("chimera:library", "Personal Library", "A cozy space filled with your favorite books. The mech can be controlled from a comfy reading chair.",["Whimsy"], stars=2),
    BodyItem("chimera:ancient_tablet", "Ancient Tablet", "A massive and nearly unbreakable stone tablet engraved with an ancient language of giants.",["Terra"], stars=2),
    ArmsItem("chimera:floating_ink", "Antigravity Ink", "Ink generators that produce floating globules in the shape of arms.",["Aqua","Gooey"], stars=2),
    LegsItem("chimera:rolling_ladders", "Rolling Ladders", "An unreasonable amount of ladders with little wheels for rolling around.",["Whimsy"], stars=1),
    WeaponItem("chimera:word_changer", "Wordplay", "A strange energy cannon. When it hits a mech's fourth wall, one of the words in the description of its actions is changed.",["Anomalous","Energy"], stars=4),
    BackItem("chimera:endless_scroll", "Endless Scroll", "A scroll of paper that can never be fully unrolled.",["Anomalous"], stars=2),
    CosmeticItem("chimera:writer_drone", "Auto-Chronicler", "A small, enthusiastic drone that can observe the mech's fights and write \"slightly\" embellished descriptions of them.",["Drone"], stars=3),
    CosmeticItem("chimera:onomatopoeia", "Onomatopoeia Projector", "A device that projects holograms of comic-style onomatopoeia in the air for any nearby sounds.",["Whimsy"], stars=3),
    PowerItem("chimera:story_power", "Story Gorger", "A thin wormhole connected to a bored extradimensional entity who will supply energy in exchange for stories.",["Relationship"], stars=4),
    ...
    CockpitItem("chimera:super_library", "Memory Archive", "A cozy space extrapolated from your memory and imagination, filled with books and other media created from your experiences and favorite stories. The mech can be controlled by writing in the empty book containing the future.",["Arcane"], stars=5),
    KitItem("chimera:martial_arts", "Martial Manual", "A reference manual detailing how to control a mech to perform various infeasible feats of martial arts.",["Kinetic"], stars=1),
    WeaponItem("chimera:trap_runes", "Trap Runes", "A set of magical runes that can be painted on any surface and detonated at will.",["Arcane"], stars=2),
    CosmeticItem("chimera:rival_plushie", "Rival Plushie", "A cute plushie version of your rival's mech. It's very huggable and makes a satisfying sound when thrown at the wall.",["Relationship","Whimsy"], stars=1),
    ...
    LegsItem("chimera:teleport_legs", "Fantasy Strider", "Legs covered in swirling spells and tales of faraway places. With every step, they pierce through space and carry the mech a far distance while ignoring obstacles.",["Arcane"], stars=4),
    WeaponItem("chimera:papercuts", "Papercut Curse", "A failed paper talisman that causes a mech's pilot to inexplicably suffer papercuts from anything they do.",["Anomalous"], stars=1),
    ...
    KitItem("chimera:book_1", "Volume 1: Perfect Construction", "A magical book containing an engineer's proud reflection on a completed mech and the detailed workings, motivation, and history behind each part. It can be consumed to express the contents in reality, temporarily restoring your mech to its original condition, excluding this item.",["Arcane"], stars=4),
    KitItem("chimera:book_2", "Volume 2: Chasing History", "A magical book containing the excited rambling of a new mech pilot and their continued rush towards a rumored ancient ruin. It can be consumed to make the contents real, temporarily giving your mech a massive speed boost when moving towards a target, even without knowing its location.",["Arcane"], stars=2),
    KitItem("chimera:book_3", "Volume 3: My Favorite Place", "A magical book containing an in-depth but somewhat idealized description of an ancient giant's ruin explored by a mech pilot. It can be consumed to make the contents real, manipulating the environment of the battlefield.",["Arcane"], stars=1),
    KitItem("chimera:book_4", "Volume 4: Uncovered Disaster", "A magical book containing frantic but terse descriptions of horrors and destruction triggered by digging up ancient ruins. It can be consumed to make the contents real, triggering random destructive effects nearby.",["Arcane"], stars=1),
    KitItem("chimera:book_5", "Volume 5: Pondering of Regret", "A magical book containing the lamentations of someone that caused disaster and their deliberations of what change would have avoided it. It can be consumed to make the contents real, reverting the consequences of one of your part usages last turn.",["Arcane"], stars=3),
    KitItem("chimera:book_6", "Volume 6: Prepared Binding", "A magical book containing the extensive preparations of someone determined to restrict a mysterious power. It can be consumed to make the contents real, temporarily disabling an enemy part after the end of the current turn.",["Arcane"], stars=2),
    KitItem("chimera:book_7", "Volume 7: Seized Might", "A magical book containing records of research on controlling a dangerous power, but missing the results. It can be consumed to make the contents real, temporarily stealing an opponent's weapon, kit, or back part.",["Arcane"], stars=4),
    KitItem("chimera:book_author", "Chimera's Notes", "A magical stack of notes containing the scribblings and personal details of a particular history-loving engineer, mech pilot, and writer. It can be consumed to make the contents real, temporarily summoning the author to fight by your side.",["Arcane","Drone"], stars=3),
    KitItem("chimera:book_super", "The Scribe's Tome", "A blank book filled with an ancient power. After recording an action that was just witnessed onto a page, the page can later be torn out to reproduce that action in a manner twisted in the user's favor.",["Arcane"], stars=5),
])

homeslice = Mech("homeslice",
[
    WeaponItem("homeslice:fast_food_sign", "Fast Food Sign", "The sign of a fast food joint torn from the ground and ready to be wielded as a makeshift weapon.",["Kinetic"], stars=2),
    KitItem("homeslice:kinetic_shields", "Kinetic Shields", "Absorb a portion of the kinetic energy from an opponent's attack and redirect it to empower your own strikes.",["Kinetic"], stars=3),
    CosmeticItem("homeslice:cowboy_hat", "Cowboy Hat", "Keep the sun off your mech's face with this stylish leather cowboy hat!",["Horse"], stars=2),
    ...
    LegsItem("homeslice:chicken_legs", "Chicken Legs", "Give your mech that slavic mythology flair with these baba yaga style robotic chicken legs.",["Beast"], stars=2),
    BodyItem("homeslice:spartan_cuirass", "Spartan Cuirass", "A bronze humanoid torso hammered to resemble a chiseled set of abs, flattering and intimidating all at once.",["Classic"], stars=2),
    LegsItem("homeslice:8_foot_vertical_leap", "8 Foot Vertical Leaps" ,"A hydrologic set of legs resembling those of a rabbit or kangaroo and built to excel in Huge Leaps and Powerful Kicks.",["Aqua","Beast"], stars=4),
    ArmsItem("homeslice:king_of_the_ring", "King of the Ring", "For those who like to get up and personal these powerful punchers are where it's at, complete with reinforced fists of steel.",["Kinetic"], stars=3),
    BodyPlanItem("homeslice:carcinization", "Carcinization", "ALL BECOMES CRAB", {"legs":6, "arms":2}, stars=4,tags=("Aqua","Beast")),
    WeaponItem("homeslice:reaper_man", "Reaper Man", "a giant scythe with a razor sharp edge and a sick skull carving at the top.",["Kinetic"], stars=3),
    ...
    CosmeticItem("homeslice:sick_ass_demon_horns", "Sick Ass Demon Horns", "+10 Headbutt Damage",["Mythical"], stars=3),
    LegsItem("homeslice:rockin_rollerblades", "Rocking Rollerblades", "Give your mech an extra boost of speed with these rocket propelled rollerblades- remember to wear a helmet!",["Kinetic","Pyro"], stars=4),
    BackItem("homeslice:lashers", "Lashers", "Two thick snakelike appendages that extend from the back of the mech that can be used to restrain/grapple an opponent.",["Kinetic"], stars=3),
    WeaponItem("homeslice:giant_ass_sword","Giant Ass Sword","This sword is impractically large, even when being wielded by a Mech, but it's fine, because you're, like, the chosen one or whatever.",["Kinetic","Whimsy"],stars=3),
    CosmeticItem("homeslice:fanservice","Fan Service","Your mech is now the sexiest character in the show. It has grown a fantastic set of mecha-mountains, and comedic underwear shots may be in its future.",["Whimsy"],stars=1),
    CosmeticItem("homeslice:cherry_blossoms","Cherry Blossoms","Your mech is covered in a dusting of pale pink cherry blossom petals at all times, that flutter about dramatically during a fight (or heartfelt confession).",["Terra","Whimsy"],stars=1),
	CosmeticItem("homeslice:mega_mech_cosplay","Mega Mech Cosplay","Giant cosplay of a character of your choosing custom fitted to your mech. Don't ask how they got the measurements, that's a secret.",["Relationship","Whimsy"],stars=1),
	KitItem("homeslice:emergency_powerup","Emergency Powerup","In dire straits, when the battle seems nearly lost, you can use your secret strength or magic blood or power of friendship for an emergency power up. The power was in you all along!",["Relationship"],stars=5),
])

shieldcaptain = Mech("shieldcaptain",
[
    ArmsItem("shieldcaptain:fightin_forks","Fightin' Forks","Standard issue power loader arms rigged with freight forks at the forearm. Great for committing OSHA violations and getting work done.",["Classic","Kinetic"],stars=2),
    ArmsItem("shieldcaptain:linemans_longarms","Lineman's Longarms","Hydraulic cherry picker armatures fitted with hands for all the fun stuff uncertified people never got to touch.",["Classic","Kinetic"],stars=2),
    ArmsItem("shieldcaptain:uppercut_manifolds","Uppercut Manifolds","Aerodynamic arms optimized for swift CQC.",["Classic","Kinetic"],stars=2),
    BackItem("shieldcaptain:bloc_rockers_doombox","Bloc-Rockers Doombox","Brutalist vibes, epic sound. Originally an early warning siren system, it's been retrofitted to accept input from this cool 30 gig ipod I found.",["Sonic"],stars=3),
    BackItem("shieldcaptain:sidewinder_saddlebag","Sidewinder Saddlebag","It's like a purse full of missiles. Well, only one (1) missile. Stackable item.",["Pyro"],stars=2),
    BodyItem("shieldcaptain:pollywog_bulwark","Pollywog Bulwark","Frog shaped plating to make your Mecha more friend-shaped. Includes novelty keychain.",["Beast","Whimsy"],stars=5),
    BodyPlanItem("shieldcaptain:mechataur","Mechataur","Two sets of legs probably makes you faster right? Gain centaur stature and an extra set of legs but miss out on back items. Matching sets of legs make you even cooler.",{"legs":4,"arms":2,"back":0},stars=2,tags=("Horse",)),
    BodyItem("shieldcaptain:pipe_frame_chassis","Pipe Frame Chassis","No armour? No problem. Feel the wind in your hair and the lack of all nonessential safety equipment at your very exposed sides.",["Aero"],stars=2),
    CockpitItem("shieldcaptain:panopticon","PANOPTICON ","SEE EVERYTHING FROM YOUR TOWER - LEAVE NO WEAKNESS UNOBSERVED (interior accommodations of swiveling captains seat and gyroscopically stable coffee machine available with request)",["Sensory"],stars=2),
    CosmeticItem("shieldcaptain:salvagers_sallet","Salvagers Sallet","The patron hardhat of warriors in the scrapyard, let your opponent feel your gaze and see your smile, all while not exposing too much of the face.",["Classic"],stars=2),
    CosmeticItem("shieldcaptain:firebreak_festoon","Firebreak Festoon","*Wear your laurels with pride, oh noble combatant.* A mark of honor, a garland of grease, the premier in fancy flowers that show you mean business.",["Classic"],stars=5),
    KitItem("shieldcaptain:more_cowbell","More Cowbell","Time marches on, for whom the cowbell ding-a-ling-a-lings. Destroy this item to deafen opponent.",["Sonic"],stars=1),
    CosmeticItem("shieldcaptain:depot_deputy","Depot Deputy","50-Gallon bucket for a hat. Various colors available, but only in shades of orange.",["Whimsy"],stars=1),
    KitItem("shieldcaptain:space_jam_dvd","Space Jam DVD ","Metaphorically dunk on your opponents no more, dunk for real with the Space Jam DVD. Boosts jump height and grants a basketball size grenade. You know what to do.",["Kinetic","Whimsy"],stars=1),
    KitItem("shieldcaptain:kickass_combo_meter","Kickass Combo Meter","Chain hits without getting hit to increase the combo up to 10. When full, hit your opponent with an unavoidable monologue that gives you enough time to make 1 repair.",["Energy","Sonic"],stars=4),
    KitItem("shieldcaptain:rally_spec","Rally Spec","Flared fenders, massive coilover suspension augmentations, and KC daylighter 100,000 lumen pod lights.",["Luminous"],stars=2),
    KitItem("shieldcaptain:emergency_brake","Emergency Brake","Initiate a drift with a careful pull, or completely arrest all momentum at a moments notice. I hope you have a 5 point harness in there.",["Kinetic"],stars=1),
    KitItem("shieldcaptain:ravishing_capelet","Ravishing Capelet","Stitched with style and zeal, two very real elements, bewilder your opponent as you shroud deft maneuvers from sight and scanners alike. It's also like, really fancy.",["Kinetic","cosmetic"],stars=4),
    LegsItem("shieldcaptain:komatsu_battletread","Komatsu Battletread","Stylish kicks to get you and the earth moving. These repurposed treads make for a great option in quick repositioning and gliding stance charges.",["Kinetic","Terra"],stars=2),
    LegsItem("shieldcaptain:courier_cargopants","Courier Cargopants","You would not believe how many pockets these things have. Gain a kit slot that can hold systems of 2 star rarity or lower.",["Whimsy"],stars=2),
    LegsItem("shieldcaptain:duelists_dualie_axle","Duelists Dualie-axle","Comedically large and over spec-ed roller skates. Be nimble and funny as you dance circles around your opponent.",["Kinetic"],stars=3),
    ...
    LegsItem("shieldcaptain:fleet_feet","Fleet-Feet","Mass produced and eternally reliable gas piston springs make great passive stabilizers for cable tendon actuated limbs. A streamlined system for lithe builds.",["Aero","Kinetic"],stars=2),
    PowerItem("shieldcaptain:neutrino_of_dubious_mass","Neutrino of Dubious Mass","This... Violates the laws of physics right? It's the size of a beach ball! And it weighs a ton! How does this even work?!",["Anomalous"],stars=4),
    PowerItem("shieldcaptain:daybreak_maw","Daybreak Maw","Midriff mounted gaping maw of fire, burns bright with your hunger for battle! (Fire extinguisher not included)",["Beast","Pyro"],stars=4),
    PowerItem("shieldcaptain:ludicrous_lumpstick","Ludicrous-Lumpstick","Who needs *proper* valve timing anyway? Increases top speed, might explode. Flooring it compels you to roll 1d6, on a 6 *something* breaks.",["Pyro"],stars=1),
    PowerItem("shieldcaptain:purpose_built_pompadour","Purpose-built Pompadour","Monolith of hair that defies gravity, channel its strength to lift yourself higher. Needs to be maintained with an equally large pocket comb.",["Whimsy","kit"],stars=3),
    WeaponItem("shieldcaptain:delvers_dredge","Delvers Dredge","A hefty anchor of dubious origin, recovered from the depths of the Core. Use this weapon to halt yourself or an opponent in their tracks.",["Aqua","Kinetic"],stars=3),
    WeaponItem("shieldcaptain:four_meter_monkeywrench","Four-Meter-Monkeywrench","A common overscale pipe wrench made to service the infinite shrimp pipelines. Makes a fine bludgeon for mecha gacha combat.",["Kinetic"],stars=2),
    WeaponItem("shieldcaptain:tachyon_lance","Tachyon Lance","Mechs can have a little time travel, as a treat. Fires a beam of time, great for rusting out your opponents armour or getting 28 hours of sleep in about 4 seconds.",["Anomalous","kit"],stars=3),
])

n217 = Mech("n217",
[
    WeaponItem("n217:ace_of_swords","ARC110//Ace of Swords","Mass-produced mech cannon, spec'd for penetrative capability over destructive power.",["Classic"],stars=1),
    BodyItem("n217:ace_of_cups","ARC120//Ace of Cups","Basic, mass-produced mech frame. Has barely enough space inside for a single pilot.",["Classic"],stars=1),
    ArmsItem("n217:ace_of_pentacles","ARC130//Ace of Pentacles","Mass-produced mech arms, with nimble, articulated digits capable of delicate work—at the cost of actual material strength.",["Classic"],stars=1),
    LegsItem("n217:ace_of_wands","ARC140//Ace of Wands","Mass-produced mech legs, which comes with an autonomous movement scheme, allowing—at the flip of a switch—for a mech to run towards a destination, without pilot input, and without any heed to obstacles or hazards in the way.",["Classic"],stars=1),
    CosmeticItem("n217:the_fool","ARC000//The Fool","A mechanical bird, styled after A.R.C.’s logo, perched on top of the mech. ARC000 uses a negligible amount of fuel to chirp and flap its wings, as well as to stabilize against impact or wind—to always remain standing, always looking ahead.",["Beast"],stars=2),
    ...
    WeaponItem("n217:the_high_priestess","ARC002//The High Priestess","A phantasmal armament. ARC002 is a durable straight sword, perpetually surrounded by some dozen near-identical holograms of itself, designed to confound the opposition and obscure trajectories of attack.",["Kinetic","Luminous"],stars=2),
    CockpitItem("n217:the_empress","ARC003//The Empress","A.R.C.’s general purpose Mech AI, which communicates via a mechanical sunflower. Through a network of “roots” which runs through the mech, ARC003 possesses the ability to detect most preliminary signs of damage, as well as perform basic maintenance and repair on the field.",["Terra","Sensory"],stars=3),
    BodyItem("n217:the_emperor","ARC004//The Emperor","A sleek, pure black mech frame. Being A.R.C.'s first—and to date, only—military contract, ARC004 is designed to withstand damage, absorb impact, and muffle electromagnetic interference to a degree that far exceeds the average duelist mech.",["Classic"],stars=3),
    CockpitItem("n217:the_hierophant","ARC005//The Hierophant","A.R.C.'s environmental analysis Mech AI, which communicates via a hologram of a stylized eye. Built directly into ARC005 is a complex physics engine, allowing the AI to near-perfectly predict the location and movements of enemy mechs—regardless of any effects interfering or restricting visibility.",["Sensory"],stars=3),
    KitItem("n217:the_lovers","ARC006//The Lovers","A liquid which gathers near any exposed 'wounds' on a mech. Acting as a universal binding agent, ARC006 can attach to *any* mech parts—such as the mech's own severed limbs, or the arms and legs “borrowed” from enemy mechs—and anchor them to any damaged sections, allowing quick on-field repair.",["Anomalous","Gooey"],stars=4),
...
[
    ArmsItem("nevephoenix:dragon_knight_arms","Dragon Knight Armor","Beautiful polished armor, built to last against dragon fire without scorching the knight inside.",["Classic","Pyro"],stars=3),
    ArmsItem("nevephoenix:bear_arms","Bear Arms","Strong hairy bear arms. Build to catch salmon quickly.",["Beast"],stars=2),
    LegsItem("nevephoenix:cursed_red_shoes","Cursed Red Shoes","These legs come with red shoes cursed to dance until you drop. You do dance fantastic though.",["Kinetic"],stars=1),
    LegsItem("nevephoenix:glass_slippers","Glass Slippers","Beautiful strong dragon-glass slippers on very pretty legs. Perfectly sized for your mech, and excellent to run in.",["Whimsy"],stars=4),
    BodyItem("nevephoenix:princess_dress","Princess Dress","Beautiful and sparkly, it flows in a ballgown fashion.",["Whimsy"],stars=1),
    BodyItem("nevephoenix:swan_princess","Swan Princess","A ballgown made of magical feathers, each glowing and fluttering in the wind.",["Beast","Whimsy"],stars=2),
    ...
    BackItem("nevephoenix:pixie_wings","Pixie Wings","Small and flight enabling, these green dragonfly wings will help you move quickly.",["Aero","Beast"],stars=1),
    BackItem("nevephoenix:dragon_wings","Dragon Wings","Large draconian Wings, allowing powerful flight causing gusts of wind when you land.",["Aero","Mythical"],stars=3),
    WeaponItem("nevephoenix:magic_wand","Magic Wand","Use your imagination to transform one thing into another thing temporarily.",["Arcane"],stars=4),
    WeaponItem("nevephoenix:pheonix_fire","Phoenix Fire","White-hot flame that shoots out of your mech's hands.",["Pyro"],stars=3),
    CosmeticItem("nevephoenix:frog_prince","Frog Prince","Your mech has powerful amphibian legs, or webbed fingers and a very nice doublet or a feathered hat.",["Aqua","Beast"],stars=3),
    PowerItem("nevephoenix:true_loves_kisses","True Love's Kisses","Feelings describe the power contained in a kiss. Words do not.",["Relationship"],stars=5),
])

zapterra=Mech("zapterra",
[
    KitItem("zapterra:standard_shoes","Standard Shoes","Shiny, black. One inch heels, thin suede soles, and laces. Driving steps, quick rotation, movement with a partner.",["Kinetic"],stars=1),
    KitItem("zapterra:latin_shoes","Latin Shoes","Matte, black. Four inch heels, thin suede soles, and laces. Hip action, quick redirections, push and pull connection with a partner.",["Kinetic"],stars=1),
    PowerItem("zapterra:paso_doble","Style: Paso Doble","Your eyes never leave your opponent. Confidence, showmanship, strength, domination. Complete control of the battle's pace. Flamenco styling in the arms.",["Kinetic"],stars=2),
    PowerItem("zapterra:foxtrot","Style: Foxtrot","Beautiful, streamlined motion with powerful posture that never wavers. Getting in the way of your path of motion is a bad idea.",["Kinetic"],stars=2),
    PowerItem("zapterra:waltz","Style: Waltz","Beautiful, streamlined motion and rotation. Aggressive possession and control of space with strong, extended, mobile posture.",["Kinetic"],stars=2),
    PowerItem("zapterra:quickstep","Style: Quickstep","Impossibly fast, to the detriment of technique. Breakneck steps, hops, kicks and redirection. Impossible to predict, with distances closed in a fraction of an instant.",["Kinetic"],stars=2),
    PowerItem("zapterra:jive","Style: Jive","Your every energy and optimization is placed into the strength, speed and length of blazing fast kicks, leg movement, and footwork. Flashy, without the need for a partner.",["Kinetic"],stars=4),
    PowerItem("zapterra:rumba","Style: Rumba","Slow and intentional movement with extensive hip action, legwork, and tension between partners. Spot rotations so fast you can't see them happen.",["Kinetic"],stars=2),
    BodyPlanItem("zapterra:standard_frame","Standard Frame","Two sets of facing bipedal legs that shift in and out of line. Upper body locks in place, redistributing impacts to the system. Forgoes weapons, favoring momentum and rotation with occasional kicks. 4 legs, 2 bodies, 2 power sources, 2 cockpits, 1 back.",{"legs":4,"weapon":0,"body":2,"cockpit":2,"power":2},stars=4,tags=("Kinetic",)),
    CosmeticItem("zapterra:competition_number","Competition Number","How else will the judges call you back?",stars=1),
    CosmeticItem("zapterra:spray_tan","Spray Tan","Helps you look more natural when you're under bright lighting. Helps you look more scary when you're not.",["Gooey"],stars=1),
    CosmeticItem("zapterra:competition_dress","Competition Dress","A flowing dress in beautiful colors. Decorated with two bajillion rhinestones.",["Luminous"],stars=2),
    CosmeticItem("zapterra:tailsuit","Tailsuit","Handsome. Stylish. Classy. Sweaty.",["Classic"],stars=2),
    PowerItem("zapterra:ten_dance_champion","Ten-Dance Champion","Relentless endurance. Unmatched aggression and intentionality. You know exactly where you are, how you're about to move, and where your opponent's balance could use some improvement.",["Kinetic"],stars=5),
    KitItem("zapterra:kinetic_anchorage","Kinetic Anchorage","A nanite field that allows you to to push, pull, and redirect momentum from points in midair. Almost as good as a partner.",["Kinetic"],stars=3),             
])
...
[
	...
	KitItem("jcterran:flare_gun","Flare Gun","A compact flare gun, usually integrated with a mech's hull. Emits a broad spectrum of non-harmful radiation in compliance with TGPA safety standards. Can burn enemies on direct contact, but will do very little to armor. Can fill either a kit or weapon slot.",["Classic","Luminous","weapon"],stars=1),
	KitItem("jcterran:allied_expertise","Allied Expertise","This old comms array has been weathered by years of use. Once per battle, you can contact an expert, who reveals some important information about an opponent's mech that can help you win the fight.",["Relationship"],stars=3),
	KitItem("jcterran:ammo_cryogenic_incendiary","AMMO: Cryogenic and Incendiary","Advanced ammunition for your weapons. The first is a munition designed to light enemies (and objects) on fire, and the second can freeze parts of enemies and render armor plates brittle. Contains enough ammo for two rounds of attacks with one weapon, each.",["Cryo","Pyro"],stars=2),
	KitItem("jcterran:ammo_singularity_stellar","AMMO: Singularity and Stellar","Advanced ammunition for your weapons. One set collapses into short-lived black holes, pulling anything nearby towards the point of impact. The other generates small stars which linger, lighting the area and burning anything nearby. Has enough ammo for one round of attacks with one weapon, each.",["Luminous","Space"],stars=4),
])
...
[
	...
	KitItem("urirles:last_century_embedded_electronics","Last Century Embedded Electronics","Listen, if it was good enough for working on the Lantern III Scrapyards fifty years ago, it's still good enough now. Old and clunky, yet also hardened and missing some of the wireless stuff that make modern mechs remotely hackable.",["Classic","Energy"],stars=1),
	BodyItem("urirles:scrapyard_field_upgrade","Scrapyard Field Upgrade","A bunch of steel plates haphazardly welded around the body of your mech, adding quite a bit of improvised spaced armor.",["Classic"],stars=1),
	LegsItem("urirles:heavy_duty_pneumatic_legs","Heavy Duty Pneumatic Legs","Two big steel legs, powered by massive pistons. Rugged and reliable, those won't get you anywhere fast, but they will get you there eventually. And noisily.",["Aero"],stars=1),
	WeaponItem("urirles:foam_cannon","Foam Cannon","Used to put out fire and seal hull breach, the rapid hardening foam can be retasked to impair your opponent's movements.",["Gooey","Pyro"],stars=1),
	CockpitItem("urirles:extreme_environment_cockpit","Extreme Environment Cockpit","This cockpit will keep you safe in the most hostile of work environment, from temperature control to radiation shielding. It will also give you an accurate reading of all that fun stuff it's working hard to keep outside.",["Cryo","Pyro"],stars=2),
	...
	ArmsItem("urirles:hydraulic_clamps","Hydraulic Clamps","Heavy arms that ends in massive clamps. Can grab and lift some hefty weights, but do not expect to pick up eggs.",["Kinetic"],stars=2),
	CosmeticItem("urirles:white_noise_backing_signal","White Noise Backing Signal (Loud)","Normally used for workplace safety, this speaker has been hot-wired to announce your approach with a wave of white noise.",["Sonic"],stars=3),
	WeaponItem("urirles:steel_cutting_beam","Steel Cutting Beam","Short-ranged, but able to punch through most conventional armour. Can't help you against shield or reflective material. Most often put on a shoulder mount, leaving the hands free to hold the target.",["Energy"],stars=3),
	BackItem("urirles:onboard_forge","Onboard Forge","This portable (if cumbersome) factory allows you to build spare parts or field fortifications. It churns a good amount of smoke while in use.",["Pyro"],stars=3),
	KitItem("urirles:structural_analyser","Structural Analyser","Initially used in demolition work, this sensor suit gives you an internal 3D representation of whatever you scan, helping to pinpoint weak spots.",["Sensory"],stars=4),
	BodyPlanItem("urirles:modular_fittings_points","Modular Fitting Points","By optimising space usage and adding universal internal and external mounting points, you can plug another Kit and another Back item. It also makes repairing easier by just switching damaged parts.",{"back":2,"kit":2},stars=4,tags=("Classic",)),
	BackItem("urirles:onboard_nanoforge","Onboard Nanoforge","Cutting edge nanomachine powered forge in a sleek design, it can produce most small parts almost instantly, or build structure remotely by dropping nano-goo. And no smoke!",["Gooey","Pyro"],stars=5),
])

bogle=Mech("bogle",
[
	BodyItem("bogle:red_herring","Red Herring","A sleek aquadynamic body plan with a splash of red. Lauded for its unrivaled formula of balancing speed and evasion in deep water environments, but criticized for sluggish performance in terrestrial arenas.",["Aqua","Beast"],stars=1),
	CockpitItem("bogle:rival's_hoodie","Rival's Hoodie","You wear a hoodie your rival gave you to help you recover when you showed up beaten, battered, and shivering cold. You definitely aren’t still wearing it because it carries any special meaning or anything, it’s just comfortable, alright??",["Relationship","cosmetic"],stars=3),
	BodyPlanItem("bogle:skillet","Skillet","It’s not about what’s above, but what’s below. While it might not seem much of a threat out in the open, this pancake of a body plan is ideal for rapidly burrowing into sediments. It sacrifices a kit slot for an additional mount for earth breaking weapons.",{"legs":2,"arms":2,"weapon":3,"kit":0,},stars=1,tags=("Aqua","Beast")),
	LegsItem("bogle:red_heron","Red Heron","A set of digitigrade legs that can move as swiftly through shallow waters as they can dish out kicks.",["Aqua","Beast"],stars=1),
	ArmsItem("bogle:bubblers","Bubblers","These caged propellers attach to the joints of your mech allowing for swift– but obvious– movement underwater. An especially clever pilot can use these bubbles to their advantage.",["Aqua","legs"],stars=1),
	CosmeticItem("bogle:mentor's_mark","Mentor's Mark","Your mech features a marking, dent or piece of equipment salvaged off your mentor’s mech.",["Classic","Relationship"],stars=1),
	BodyItem("bogle:hatchet","Hatchet","Anyone packing a heavy arsenal knows that the hatchet is the very best, what it lacks in speed it more than makes up for in control. Able to easily reposition for heavy melee strikes, but beware this buoyant armor is highly flammable! Round and bulky in spite of its name.",["Aqua","Beast"],stars=2),
	CosmeticItem("bogle:mentor's_mask","Mentor's Mask","A time comes when an Ace must pass on their reputation, this Transforming Mask bears a visage crafted by your mentor and conceals your own. When you open it, describe it briefly, then the commentator is obliged to tell the audience a fact about your mentor. (These facts can be lies.)",["Classic","Relationship"],stars=2),
	BodyPlanItem("bogle:kiwi","Kiwi","A haphazard and patently offensive interpretation of a kiwi. It has a single arm as a neck allowing you to attack from above even without high ground.",{"legs":2,"arms":1,},stars=2,tags=("Beast",)),
	WeaponItem("bogle:limpet_lance","Limpet Lance","It's a lance for jousting, the dimples in the surface look like limpets.",["Aqua","Beast"],stars=3),
	KitItem("bogle:adipose_anarchy","Adipose Anarchy","These adaptable fins deploy from the limbs of your mech in water and rotate to accommodate movement.",["Aqua","Beast"],stars=3),
	BackItem("bogle:dorsal_duo","Dorsal Duo","Dart through the depths with this pair of fins that protrude from the back of your mech!",["Aqua","Beast"],stars=3),
	CockpitItem("bogle:mecha_mollusk","Mecha Mollusk","Whatever it came from has long since returned to the place from whence it came, but it left this chrome shell behind. The shell serves as a semi-spacious cockpit and grants an additional weapon slot that can be used when it's opened.",["Aqua","Beast"],stars=4),
	WeaponItem("bogle:mano'war","Man-O'War","Barbed industrial power cables dangle over one of your mech's limbs like a cape. Catch an opposing mech with these and you can directly hook your power source up to the attached part's power circuit, overloading them. More effective the stronger your power output is compared to your target's.",["Beast","Energy"],stars=4),
	KitItem("bogle:weather_transmogrifier","Weather Transmogrifier","It's already bad enough that you can't predict your rival's next move, but dealing with the forecast on top of that? No way! You've rigged up a little satellite dish to your mech that sparks and spins when turned on. It can be used once to trigger arena specific weather or a thunderstorm.",["Anomalous"],stars=5),
	PowerItem("bogle:bivalve_engine","Bivalve Engine","Unsuited for terrestrial arenas and prone to overheating, this engine comes standard with a powerful pump to keep it cool. While it provides more than ample power, no amount of clandestine tech can hide your heat signature. Maybe you want someone to notice you?",["Aqua","Beast"],stars=4),
])
...
[
	...
	BodyItem("avashinedrake:the_oncoming_flood","The Oncoming Flood","Endless streams of water pour out of the mouths of carved gargoyles, which jut from a stately limestone facade. Concealed inside is a complex chemical reaction that turns the waste products of your reactor into a truly staggering quantity of water. Better get to higher ground…",["Aqua"],stars=5),
	CosmeticItem("avashinedrake:predators_grace","Predator's Grace","Sinuous movements, coiled and ready to attack. It only takes a moment of watching this mech move to know how deadly it is. Keep your wits about you. You’ll need them.",["Beast"],stars=4),
	CockpitItem("avashinedrake:wide_open_sky","Wide Open Sky","Your eyes look perpetually upwards, and your mind yearns to float among the clouds. If you spend an entire turn flying without declaring an attack, you spot something on the battlefield below that could help you win the fight, perhaps an interesting terrain feature or a rusted but functional relic.",["Aero"],stars=2),
])
...
shop_gacha = Mech("shop_exclusive",
			[
				...
				BodyItem("shop:pyrrhonic_obsidian","Pyrrhonic Obsidian","An infernal chassis, forged from the blackest metals of the depths. This alloy regenerates when exposed to heat or flames, acting as a healing factor, but can become brittle if struck by Cryo or Aqua damage.",["Mythical","Pyro"],stars=5),
				...
				ArmsItem("shop:fiddler_claw","Fiddler Claw","An asymmetrical pair of arms. One is massive and brawny, able to hold an enlarged version of its equipped weapon, whilst the other is miniscule and can't hold weapons, but contains a necessary gyro module to keep your mech stable under the weight imbalance.",["Aqua","Beast"],stars=2),
				...
				LegsItem("shop:condor_claws","Condor Claws","Huge, raptor-like mecha-talons, which can be used for slashing attacks. A flying mech can even grab and lift enemy mechs, pulling them into the air and dropping them. Let gravity do the rest.",["Aero","Beast"],stars=4),
				LegsItem("shop:thighdies","Thigh-Dies","These sleek yet nondescript mech legs come equipped with mobility-boosting thrusters on the hips and, hidden within the thighs, a set of missile pods, ideal for a surprise attack or to throw off heat-seeking attacks. You've only got one salvo per thigh, though. Better make it count.",["Kinetic","Pyro"],stars=4),
				...
				CockpitItem("shop:phone_a_friend","Phone-A-Friend","A sparkly flip-phone with a multiversal data plan. Once per battle, you can briefly call up anyone you want for advice on how to handle your current situation, or just for a chat. Yes, even that person you're thinking of. We don't know how it gets through to them, either.",["Anomalous","Relationship"],stars=1),
				...
				WeaponItem("shop:gutripper","Gut-Ripper","A fiendish spear with an armoured, mechanized tip on its end. Impaling another mech with the spear will cause the tip to split open, unleashing a series of spinning blades to tear apart the mech's internals, though making it nigh-impossible to remove.",["Classic"],stars=3),
				WeaponItem("shop:the_power","The Power","A legendary axe, coated in sigils that pulse to beat of Earth's Melody. Strumming shoots lightning from the guitar's head, and your riffs buff your allies' evasion. Intense shredding amplifies your attack power even further, but quickly drains power sources.",["Energy","Sonic"],stars=5),
				WeaponItem("shop:mech_solver","The Mech-Solver","An industrial nozzle replaces one of your mech's hands, with a thick rubber hose running to an acid tank on the forearm. Can fire projectile blobs or a continuous stream, coating enemies in acid that constantly eats away at their armour until it's washed off, but has limited ammo.",["Gooey"],stars=3),
				...
				BodyPlanItem("shop:jormungandr","Jörmungandr","A chimeric blueprint that merges together up to five different Body parts in order to create a gigantic, unstable form.",{"legs":2,"arms":2,"body":5},stars=3,tags=("Anomalous",)),
				...
				BodyPlanItem("shop:centipede","Centipede","Fun Fact: Despite the name, no species of centipede has exactly 100 legs. This body plan aims to correct that fact. Good luck filling in every slot.", {"legs":100,"arms":0},stars=4,tags=("Anomalous","Beast")),
				...
				BodyPlanItem("shop:skew_apeirogon","Skew Apeirogon","A pure, jagged energy form, generated by a power source. The body is unable to be damaged by attacks. However, it offers no protection to any equipped parts, and destabilizes when hit with Sonic attacks. Can't equip a Body part. Limb parts are optional, and used as corporeal armour.",{"legs":2,"arms":2,"body":0},stars=4, tags=("Energy","Luminous")),
...
[
	...
	BackItem("boss:mountain_kings_crown","MOUNTAIN KING'S CROWN","A truly massive crown, taken from a truly massive king. Although it is built from sturdy concrete and armor plate, a crack splits the front in two. Whether you wear it as a badge of honor or a warning to future monarchs, you're sure to wear it well. After all, you've earned it.",["cosmetic","Mythical","event"],stars=5),
])
...
[
    WeaponItem("event_formal:intergalacticsky", "F.L.P. Rippers", "Excessively long and ornately detailed nails ready to Slay your Enemies, in true industry fashion.", stars=3, tags=("event","Kinetic")),
    CosmeticItem("event_formal:hillexed", "Smoochable Lips", "A large pair of realistic lips adorn the outside of the cockpit. They have limited articulation, just in case you need to pucker up.", stars=3, tags=("event","Whimsy")),
    KitItem("event_formal:loading", "Gyroscopic Stabilizer", "a bleeding edge internal part that prevents the mech from losing their balance and falling over. ideal for elaborate dances or striking truly insane poses", stars=3, tags=("event","Kinetic")),
    ...
    WeaponItem("event_formal:oneirocartographer", "Razorsilk Skirt", "Your mech wears a long, flowing skirt made of an ultrafine biometallic alloy. Twirl right and you can slice an opponent in half – just be careful with it on the dance floor...", stars=3, tags=("event","Kinetic")),
    CosmeticItem("event_formal:thecowofeternalflame", "Aetherial Ball Gown", "A stunning long flowing black gown made of aetheric energy and swirling constellations. The gown has short poofy off-shoulder sleeves and the bottom trails on the ground a bit after your mech. The pattern continuously shifts and the stars glitter from every angle.", stars=3, tags=("event","Space")),
    CockpitItem("event_formal:triangle", "Table for Two", "Your cockpit is a secluded table, set for two. The carpet is red. The decor is Art Deco. A system of ceiling tracks suspend two chairs and a butlerprobe with bespoke arms for every need and a snazzy bowtie. Now all it needs is your date 😳👉👈", stars=3, tags=("event","Relationship","Whimsy")),
    WeaponItem("event_formal:theoddman", "Oversized Tin Cans", "Oversized tin cans attached to string from a mech marriage ceremony. A part of romantic(?) tradition for some reason. Can be used either as a weapon or a cosmetic.", stars=3, tags=("event","Kinetic","Relationship")),
    CosmeticItem("event_formal:ditto", "Fancy Top-Hat", "The most formal of formal attire.", stars=3, tags=("event","Classic")),
    CosmeticItem("event_formal:p_rker", "Collar", "Indicates a mech's name and point of origin, and makes a decisive fashion statement.", stars=3, tags=("event","Classic")),
    PowerItem("event_formal:loftyinclination", "Wedding Band", "A band of precious metal, otherwise inert. Somehow, your mech is far more resiliant when wearing it, though there has been a notable decrease in your attack damage when facing off against your rival.", stars=3, tags=("event","Relationship")),
    CosmeticItem("event_formal:neve", "Fascinator", "A beautifully elaborate hat, slightly small for the head.", stars=3, tags=("event","Classic")),
    CosmeticItem("event_formal:n217", "ARC138//Nine of Pentacles", "Originally created to celebrate the new millennium, ARC138 is an endless stream of golden radiance, flowing unimpeded from the hands of the mech. This obscene wealth is not real, and leaves nothing behind—merely a masterful (and highly over-indulgent) trick of the light.", stars=3, tags=("event","Luminous","Mythical")),
    WeaponItem("event_formal:cheesesnack", "Literal Chocolate Bomb", "Coat your target in sticky, searing-hot chocolate that hardens as it cools. A product of the Iron Chef Wars.", stars=3, tags=("event","Gooey","Whimsy")),
    BodyItem("event_formal:colabot", "Ghostly Garments", "An ethereal, semi-transparent body dressed in fancy cocktail attire. Despite its intangible nature, it seems to be able to attach to the other components of your mech just fine. Impervious to physical damage - attacks just phase through. Can’t kill what’s already (drop) dead (gorgeous)!", stars=3, tags=("event","Anomalous")),
    WeaponItem("event_formal:cheshire", "Girl's Best Friend", "Usually worn as a tiara, broach, or cufflink, the beam fired from this enchanted jewel grows more powerful for each reflective or crystalline surface on your mech.", stars=3, tags=("event","Energy","Luminous")),
    PowerItem("event_formal:bytes", "Kaiju Blood", "This mech is powered by the ancient spirit within the blood of a kaiju.", stars=3, tags=("event","Anomalous")),
    CosmeticItem("event_formal:intoamutecrypt", "Symphony In C", "It's warm and golden like an oven that's wide open.", stars=3, tags=("event","Sonic")),
])

event_fauna = Mech("FRONT's FAUNA Invitational",
[
    LegsItem("event_fauna:bytes","NewtTech Legs","Lose a limb? Regrow it!",stars=3,tags=("event","Beast")),
    BodyPlanItem("event_fauna:triangle","Metamorphosis","Your mech is still developing. It begins an encounter as a highly armored low mobility crawler: 2 weapons, 0 limbs. Upon maturity the carapace cracks, allowing what has developed to burst forth, a new shape rapidly hardening as it exits: 3 sets legs, 0 arms, can fly. No item is shared between forms.",{"weapon":4,"arms":0,"legs":3,"kit":2,"back":2,"power":2,"body":2},stars=3,tags=("event","Beast")),
    WeaponItem("event_fauna:ditto","Volt Beetle Horn","This horn seems to be inspired by the Volt Beetles that live in the Core, slowly generating a static charge that can be released to stun opponents.",stars=3,tags=("cockpit", "event","Beast","Energy")),
    ...
    BackItem("event_fauna:syl","Horse Back","It’s a horse, tied to your back. It whinnies occasionally and you can feed it oats.",stars=3,tags=("event","Drone","Horse")),
    BackItem("event_fauna:loading","Photaxis Phlare","A back mounted phase drive that plunges you into the immateria. While submerged in this way you may only move towards sources of strong UV radiation. Luckily this system is also equipped with a strong UV flare gun to provide valid lights, but other lights are also valid.",stars=3,tags=("weapon", "event","Beast","Luminous")),
    PowerItem("event_fauna:moonbug","Electric Eel Tank","A large aquarium holding a happy group of electric eels that help power your mech.",stars=3,tags=("event","Aqua","Beast")),
    KitItem("event_fauna:thecowofeternalflame","Blood Vents","These vents are connected to whatever fluid the mech uses to keep itself functioning. Like the Horned lizard this is designed after, this allows the mech to fire a short-range blast of it's own \"blood\" as a defense mechanism.",stars=3,tags=("event","Aqua","Beast")),
    KitItem("event_fauna:bee","Adaptive Skin","The skin of this mech can change colour and texture in order to communicate, look cool, and camouflage itself. It does not perfectly replicate what is behind it, but instead it can achieve the general vibes of the surface the mech is on.",stars=3,tags=("event","Beast","Sensory")),
    BodyPlanItem("event_fauna:hill","Planarian Power","This flatworm bodyplan has zero legs and must wriggle on the ground. However, the first time your mecha is cleanly cut in half, each half can regenerate into a full mecha!",{"legs":0},stars=3,tags=("event","Beast")),
    KitItem("event_fauna:st_yietus","HAGSKIN DISSUASION SYSTEM","Inspired by the humble hagfish, this system emits voluminous slime from your mech's skin to engulf your foes. The slime expands exponentially in liquid, clogs up enemy intakes, and thanks to a special blend of exotic polymers it also weakens incoming attacks of all kinds! It's the perfect defense.",stars=3,tags=("event","Beast","Gooey")),
    KitItem("event_fauna:intergalacticsky ","Vibrissae","Sensory arrays are placed on key parts of the mech, allowing for increased detection of movement, wind, and other disturbances. Extremely sensitive and easy to max out.",stars=3,tags=("event","Beast","Sensory")),
    ArmsItem("event_fauna:chimera","Featherful","Fluffy and colorful feathered wings that enable flight.",stars=3,tags=("event","Aero","Beast")),
    KitItem("event_fauna:cheshire","Exuvian Mimic","Shed your skin. This fragile simulacra is already dead, but your doomed twin will do as you ask. Without power, it cannot sustain itself or it's weapons for long, and without you, its poor carapace will not endure the wounds of the world. Do not begrudge your past self for its limitations.",stars=3,tags=("event","Anomalous","Beast")),
    BackItem("event_fauna:ava_shinedrake","Starbreak Anemone","Your mech has formed a symbiotic relationship with a minor eldritch entity, now anchored to its back. Midnight tendrils flow eerily around your mech, inflicting anything they touch with data hallucinogens that corrupt computers and mesmerize AI. Luckily, repeated exposure has made your mech immune.",stars=3,tags=("weapon","event","Beast","Sensory")),
    BackItem("event_fauna:chillychilichelle","Suriname Birthing Pods","A perforated metal husk inspired by the common Suriname toad. On the surface are a dozen honeycomb-like depressions, each overflowing with a viscous, translucent slime - each housing a miniature biomechanical replica of your mech, ready to burst out on command as drones.",stars=3,tags=("event","Beast","Drone")),
    CosmeticItem("event_fauna:colabot","Deer Dappling","Delicate spotting is painted on your mech’s hindquarters (or… thorax? Your mech’s caboose, alright?). It’s pretty, like the pattern of sunshine through leaves. In a very specific environment, it might help you camouflage yourself, but it most looks nice.",stars=3,tags=("event","Beast")),
    LegsItem("event_fauna:renne","Snikt Kickers","Spindly metal legs with a lining of waterproof padding. In combat, the endoskeleton's toe parts can be severed on inbuilt faultlines to pierce this padding and provide an additional weapon at a cost to durability.",stars=3,tags=("event","Beast")),
    BackItem("event_fauna:deric","Arctic-Blast Scales","Your mech's back is covered with massive metal scales. When activated, the edges glow ice blue, they lift up, and a frozen wind gushes out. With condensation, you can release a hail of ice shards. You can also curl up in a spiny frostball.",stars=3,tags=("event","Beast","Cryo")),
    LegsItem("event_fauna:blueberry","Poisonous Barbs","While poison may not be much use on an opponent's mech, they still are a very fashionable accessory for everyone who likes platypi.",stars=3,tags=("event","Beast","Gooey")),
    BackItem("event_fauna:bogle","Rickety Roost","A rickety tower anchored to the back of your mech ripe with antennae and caked in guano. Once an array of scientific instruments, it's now home to your pigeons.",stars=3,tags=("event","Beast","Sensory")),
    BodyItem("event_fauna:zapterra","Extremophile","Extreme resistance to temperature (.05K-150C), pressure (40,000 kPa), sudden impacts (1.14 GPa), and radiation. Capable of making automatic repairs to wiring with access to water, able to survive in a dehydrated state for 30+ years. Can copy opponent resistances if it gets a taste.",stars=3,tags=("event","Cryo","Pyro")),
])

event_labour = Mech("The Core's 46,753rd Quadrimestral Labour Day Celebration",
[
	BackItem("event_labour:bytes","Safety Rigging","Is it dangerous to stand where you are? With proper anchoring, keep yourself and those around you on secure footing with this hook and cable array.",["event","Kinetic"],stars=3),
	CosmeticItem("event_labour:ditto","Forklift Certification","You are too late.",["event","Whimsy"],stars=3),
	KitItem("event_labour:loading","Utility Scouter","A handy piece of UI tech that tells you the location of every utility line in the area from electric, to shrimp, to water and more!",["event","Sensory"],stars=3),
	BackItem("event_labour:shieldcaptain ","Wool-Wardens Distaff","Bolts of fabric bound en-mass on banner poles. Intended for display, this weapon of tapestry makes for a unique training boffer in mech combat, able to tangle an opponent if used more inventively. But let's be real, These are the banners that should be going up in the promenade!",["weapon","event","Kinetic"],stars=3),
	...
	KitItem("event_labour:babaloga","Poorly Designed Hazard Lighting","Flashing and rotating warning lights that are FAR too bright and numerous. They actually make any situation much more dangerous.",["cosmetic","event","Luminous"],stars=3),
	KitItem("event_labour:blueberry","Window Cleaner Fluid","In a pinch, you can use it make your mech squeaky clean, which removes all debuffs. Sadly, the tank only has enough to do it once per match though.",["event","Aqua"],stars=3),
	BodyItem("event_labour:avashinedrake","Library Walker","Your mech is covered in countless bookshelves, allowing it to carry books to dangerous or remote areas that would otherwise lack them. A friendly dragon spirit works with you, guarding the books from hostile weather and mech fights alike, and her wards make your mech immune to environmental damage.",["event","Arcane","Drone"],stars=3),
	ArmsItem("event_labour:thecowofeternalflame","The All-Purpose Construction Multi-tool™","Introducing The APC Multi-tool™ for all your construction (and destruction ;) ) needs! With anything from a hammer to an excavator scoop, if it's a construction tool it's in here! These arms can even swap tool modes independently! `Koval Industrial Co. not liable for damages from improper tool use`",["weapon","event","Kinetic"],stars=3),
	KitItem("event_labour:cheshire","Maintenance Mist","The Department of Worker Non-injury authorized non-combat use of this unfire derived anti-entropy device for the near instant repair of collapsed or destroyed terrain, materials, and infrastructure. OFFENSIVE USE DURING ROBOT FIGHTS IS PROHIBITED BY DOWN. ",["event","Aqua","Blaseball"],stars=3),
	KitItem("event_labour:chillychilichelle","R.E.M.N.A.N.T. Salvage Unit","An electromagnetic pad formed from tessellated steel hexagons at alternating heights. Utilised by scrapyards and repair droids to collect valuable detritus at range. Wires, tubes, pipes, and a dozen other connective tissues flow out at the seams, allowing the mech to interface with functional scrap.",["event","Energy","Kinetic"],stars=3),
	CockpitItem("event_labour:bogle","Big Yellow","A wild world out there, but folks can rely on you to bus them from A to B. A spacious interior with a comfy pilot's seat with easy to reach forwards facing door controls. Ideal for your lil guys.",["event","Relationship","Whimsy"],stars=3),
	WeaponItem("event_labour:intergalacticsky","Dessicator","This hose of liquid-wicking gel sucks the soup out of any opposing mech, to contribute to your own oozability!",["event","Gooey"],stars=3),
	BackItem("event_labour:amiafox","The Stella Siphon","A giant energy-processor built into the back of your mech. The Stella Siphon is outfitted to space-faring courier and exploration mechs. Designed to withstand energy from stars, the Siphon can absorb, contain, and discharge various energies through your mech's torso.",["event","Energy","Space"],stars=3),
])

event_cryptid = Mech("Bizarre! The Forbidden Cryptid Gacha!",
[
	PowerItem("event_cryptid:ditto","Solar Lamp","A giant, VERY BRIGHT lamp that produces solar energy. May attract Mothmen, and also regular moths.",["event","Anomalous","Luminous"],stars=3),
	KitItem("event_cryptid:bytes","Photo-Blurring Fog","A fog surrounds the mech. Tracking with ultraviolet, visible, and infrared light cameras is rendered far less effective.",["event","Anomalous","Sensory"],stars=3),
	...
	KitItem("event_cryptid:bogle","Pidgin Parser","Parse any signal and translate any language! This intel suite is designed for pigeons, the very best at tracking Pidgins.",["event","Anomalous","Beast"],stars=3),
	...
	KitItem("event_cryptid:thecowofeternalflame","A Thousand Thousand Eyes","*perceive* Perceive **PERCEIVE** Eyes cover your mech from head to toe. Derived from a sight-based anomaly in order to nullify them. This part can absorb sight-based effects and reflect them at your opponent. More effective the more eyes and reflective surfaces your mech has.",["event","Anomalous","Sensory"],stars=3),
	BodyItem("event_cryptid:chillychilichelle","Call of the Void","Your rival's mech. It's *theirs*. It bends wrong, joints folding downward limply. Come closer. Its surface is blurry, like a memory. You see them in the cockpit, smile placid and still. Come closer. A translucent, barely-there line from the mech's roof traces up into the darkness above. Come closer.",["event","Anomalous","Relationship"],stars=3),
	KitItem("event_cryptid:chimera","Déjà Glue","A sticky substance based on research of an entity that distorts memory. It can be applied to surfaces, after which events involving the surface will \"stick\" to it, causing baffling changes as if the event had already happened multiple times previously.",["event","Anomalous","Gooey"],stars=3),
	WeaponItem("event_cryptid:urirles","Multi-phasic Net Launcher","If androids dream of electric sheep, quantum androids might dream of quantum sheep. Spun from their yarn, those nets can pin a target by sticking to the very fabric of reality wherever they stand. It will only hold them down for a few moments before drifting off this plane of existence.",["event","Anomalous","Kinetic"],stars=3),
	BodyItem("event_cryptid:loading","The Part That Makes Your Mech Explode","A bulky and unassuming body. Every turn roll a D10. On a 0, you and your mech explode.",["event","Anomalous","Pyro"],stars=3),
...
event_fantasy = Mech("Myths & Magic LARP Festival",
[
	KitItem("event_fantasy:shork","Wensleydale Guild","Your mech's hollow areas house dozens of rodents, though these ones carry something far scarier than a plague: adventurer levels, gear and teamwork. Knights tackle enemy mechs directly, supported by clerics and wizards slinging magic, whilst rogues sneak inside to attack where they least expect it.",["Beast","Drone","event"],stars=3),
	BackItem("event_fantasy:shieldcaptain","The Good Knights Rest","\"Wait, what do you mean you need four Kilometers of steel wire?\"\n*muffled comms crackle with annoyance*\n\"I can't make a weighted blanket for your mech, that's insane\"\n*another crackle, more inquisitive*\n\"A cape of chainmail, mech sized, for heat/energy dispersion? Now I can make that happen!\"",["Mythical","Whimsy","event"],stars=3),
	BodyItem("event_fantasy:yietus","MASTERWORK DWARVEN FORGEFRAME","Hand-forged by ancient artisan spirits, your mech's frame is a true masterpiece of art and artifice. It is also completely unique, and completely irreplaceable. All parts attached to this body are sturdier and more efficient, but good luck getting anything fixed in less than a decade.",["Mythical","Terra","event"],stars=3),
	WeaponItem("event_fantasy:hal","+3 Mace","A normal looking mace that's thrumming with power above the level of your everyday mace. Whenever it hits something hard enough to dent that object, three copies of the dented object are immediately manifested within short distance. Note that these copies are summoned damaged like the original.",["Anomalous","Classic","event"],stars=3),
	WeaponItem("event_fantasy:triangle","St Grendel's Lance","The conflated souls of legends lie dormant in the blood of your machine. Feeling a great hunger, you rip and tear; feeling a righteous need to protect, you sacrifice yourself. Tear off your own arm to create a massive holy lance capable of piercing even dragon scales. Shine bright as darkness looms.",["Mythical","event"],stars=3),
	WeaponItem("event_fantasy:thecowofeternalflame","SwordisSwordisSwordisSwordisSwordisSword","Cleave the horizon. This cruel, warped reflection of weaponry simultaneously looks like every sword and none of them all at once. A slash with this sword will cleave through all in your path, no matter the distance. It explodes once used, littering the battlefield with a myriad of shattered swords.",["Anomalous","Mythical","event"],stars=3),
	BodyPlanItem("event_fantasy:avashinedrake","Alacrios of the Dawn","You ride a flesh-and-blood dragon into battle. They can fire devastating beams of light from their mouth, fly on enormous wings, and wield mech-scale gear at the same time. No Cockpit or Power, wears Arm, Leg, and Body parts as armor, and can equip two additional Arcane parts in any slot.",{"legs":2,"arms":2,"cockpit":0,"power":0},stars=3,tags=("event","Luminous","Mythical",)),
	BodyPlanItem("event_fantasy:only","Bodyplan: DRAGON SOUL","A humanoid, bipedal body plan with integrated draconic wings, capable of converting into a dragon-shaped \"Flight mode\", with the weapons becoming the head and tail.",{"legs":2,"arms":2},stars=3,tags=("event","Beast","Mythical",)),
	BodyItem("event_fantasy:urirles","Glorybound Armor","An armor inscribed with your deeds, both past and future. As long as you stay true and work tirelessly for them, spells and blades will find much harder to harm you. The grander the deeds you pretend to, the better the protection. But the heavier the expectations as well...",["Mythical","event"],stars=3),
	WeaponItem("event_fantasy:intoamutecrypt","Staff Of Summon Orange Soda","A magical staff which can be used to create an arbitrary amount of an ice cold, sugary, carbonated orange-flavoured sugary drink. A Fanta sea, if you would.",["Mythical", "Whimsy","event"],stars=3),
	WeaponItem("event_fantasy:blueberry","Daisy The Sword","Daisy is a sentient magical sword embellished with beautiful flower designs, that at any time can be let go of to allow her to fight independently of your main mech. She may go rogue with her own battle plan from time to time, especially to ensure her self-preservation.",["Arcane","Drone","event"],stars=3),
	WeaponItem("event_fantasy:jcterran","Lantern of Paranoia","The light of this mystical lantern reveals invisible dangers wherever it points. In fact, it is so effective that it reveals dangers that do not otherwise exist- dastardly traps and invisible creatures manifest where it shines, only to disappear again once the lantern is turned off or turned away.",["Arcane","Luminous","event"],stars=3),
	KitItem("event_fantasy:chillychilichelle","The Mechanomicon","A dusty old tome embedded crudely into your mechs wiring, like a burrowing parasite. It's unpleasant to look at for prolonged periods. Once per fight, dredge up a fallen mech that has perished previously in this location and momentarily control it.",["Arcane","Mythical","event"],stars=3),		
	KitItem("event_fantasy:hillexed","Soar-Away Slippers","These giant blue woolen slippers make even heavyweight mechas feel light as a feather - but only when given as a gift. Stick them onto an enemy mecha's feet and they will stop feeling gravity's pull, whether they want to or not.",["Arcane","event"],stars=3),	 
])
...
event_mechs = (event_formal, event_fauna, event_labour, event_cryptid, event_discovery, event_fantasy)
