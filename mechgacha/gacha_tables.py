...
[
    ...
    BodyPlanItem("chimera:bookcase", "Giant's Bookcase", "A blueprint from the ancient giants that adds a large slot to the mech's body, allowing 5 books to be stored while using one kit slot.", {"kit": 4}, stars=2),
    KitItem("chimera:book_ms_0", "Mech's Story Condensed", "A shortened giant magical anthology that can be consumed to realize the contents, restoring a previously destroyed volume of Mech's Story.", stars=4),
    KitItem("chimera:book_ms_1", "Mech's Story Volume 1: Construction", "A detailed giant magical book that can be consumed to realize the contents, temporarily restoring your mech to its original condition at the start of the battle, excluding any consumed books.", stars=3),
    KitItem("chimera:book_ms_2", "Mech's Story Volume 2: Choice", "A thoughtful giant magical book that can be consumed to realize the contents, changing the biome of the battlefield.", stars=1),
    KitItem("chimera:book_ms_3", "Mech's Story Volume 3: Control", "A strategic giant magical book that can be consumed to realize the contents, temporarily binding the movement of an opponent's part.", stars=2),
    KitItem("chimera:book_ms_4", "Mech's Story Volume 4: Charge", "An enthusiastic giant magical book that can be consumed to realize the contents, temporarily giving your mech a massive speed boost when moving towards the enemy.", stars=2),
    KitItem("chimera:book_ms_5", "Mech's Story Volume 5: Chaos", "A terrifying giant magical book that can be consumed to realize the contents, immediately triggering random explosions on the battlefield.", stars=1),
    KitItem("chimera:book_ms_6", "Mech's Story Volume 6: Correction", "A regretful giant magical book that can be consumed to realize the contents, reverting the consequences of one of your part usages last turn.", stars=3),
    KitItem("chimera:book_ms_7", "Mech's Story Volume 7: Conquest", "A triumphant giant magical book that can be consumed to realize the contents, temporarily stealing an opponent's weapon, kit, or back part.", stars=4),
    KitItem("chimera:book_ms_8", "Mech's Story Volume 8: Calm", "A peaceful giant magical book that can be consumed to realize the contents, temporarily dampening the force of all impacts in the battlefield.", stars=1),
    KitItem("chimera:book_ms_17", "Mech's Story Volume 17: Chimera", "A self-absorbed giant magical book that can be consumed to realize the contents, temporarily summoning the author of Mech's Story to fight by your side.", stars=3),
])
