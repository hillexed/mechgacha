...
[
    ...
    KitItem("triangle:more","Arm: Prefix: More","A smaller backpack that can nest inside/under another backpack; this features multiple quick release joint housings to allow a multiplicity of arms", stars=3),
...
[
    ...
    KitItem("bytes:short_range_teleporters","Short Range Teleporters","These devices make use of anomalous technology to teleport short distances to evade attacks.", stars=3), # don't know what type this should be. mobility?
