...
[
	...
	KitItem("urirles:onboard_forge","Onboard Forge","This portable (if cumbersome) factory allows you to build spare parts or field fortifications. It churns a good amount of smoke while in use.",stars=3),
