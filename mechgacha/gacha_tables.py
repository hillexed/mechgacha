...
[
    ...
    LegsItem("st_yietus:rotborn_stomper","ROTBORN STOMPERS","Sturdy weatherproofed legs. Slow and steady, but surprisingly agile. Capable of performing short leaps and dashes to clear obstacles or close the distance. Slightly reduces the effects of debuffs.", stars=2),
    ArmsItem("st_yietus:rotborn_fist","ROTBORN FISTS","Simple arms, covered in pitted armor and tipped with a large, gauntlet-like hand. Paired with small remote manipulators for more delicate work. Even unarmed, they bear enough strength to break through any barriers set in your path. Slightly reduces the effects of debuffs.", stars=2),
    ...
    BodyPlanItem("st_yietus:tech_terror_body_plan","TECH TERROR BODY PLAN","An intricate, skeletal body plan that allows up to four arms and two weapons to be equipped instead of a body. Grants power and agility, but leaves your internals exposed. Use at your own risk.", {"arms": 4}, stars=4),
...
boss = Mech("boss",
[
	CockpitItem("boss:steeplechaser","Steeplechaser","A series of attachments in the cockpit allows a horse to be stabled and used as your mech controls. In an emergency, it can be ejected, allowing you to ride off into the sunset.",["Drone","Horse","event"],stars=5),
	...
	BodyItem("boss:dogfighter_fuselage","Dogfighter Fuselage","A chassis built from a decommissioned fighter jet, with built-in thrusters in the abdomen, and wings on the shoulders. Grants flight and impressive maneuverability, though large limb movements can compromise that.",["Classic","event"],stars=5),
	...
	WeaponItem("boss:gatling_wand","Gatling Wand","This unstable creation was confiscated off of a deranged wannabe wizard who glued a bunch of wands together. Spinning this thing up will result in it spewing off a bunch of rapid-fire, tough-to-aim magic bullets with unpredictable properties, causing random debuffs.",["Arcane","event"],stars=5),
	...
	CosmeticItem("boss:too_hot_to_handle","TOO HOT TO HANDLE","Your mech produces so much heat that it causes convection currents to form in the air around it. Your mech appears blurred and distorted, almost as if it were underwater... is it just me or is it getting hot in here?",["Pyro","event"],stars=5),
	...
	WeaponItem("boss:thrumming_blade","Thrumming Blade","Once a normal longsword, it has been heavily affected by spatial misalignment. Can be activated on a medium cooldown to put it into a state of superposition, allowing you to make two different attacks with it at once.",["Anomalous","Classic","event"],stars=5),
