...
[   
    ...
    KitItem("hal2000:credits_roll", "Adds a button to your cockpit that, when pressed, plays an unskippable credits roll across all the screens in your opponent's cockpit. Exceedingly annoying and only usable once per fight."),
