...
[
    ...
    BodyPlanItem("cheshire:nuckelavee","Nuckelavee","An adaptation of the more common Centaur Bodyplan, this long limbed rider allows an additional cockpit to be equipped at the head of the steed", {"legs": 4, "arms": 2, "cockpit": 2}, stars=3),
    ...
    LegItem("cheshire:crystalline_greaves","Crystalline Greaves", "A faint glow emminates from these vibrant gemstone legs. The razor sharp crystals seem to resonate with magical energy", stars=2),
