...
[
    ...
    CockpitItem("spellweaver:library_membership_card","Library Membership Card","With this, you can download ebooks, audiobooks, music, and games! Plus, you can check out physical materials at your local library.",["Whimsy"], stars=2),
...
[
    ...
    KitItem("shieldcaptain:kickass_combo_meter","Kickass Combo Meter","Chain hits without getting hit to increase the combo up to 10. When full, hit your opponent with an unavoidable monologue that gives you enough time to make 1 repair.",["Energy"],stars=4),
