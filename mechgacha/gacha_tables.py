...
[
    ...
    BodyPlanItem("shieldcaptain:mechataur","Mechataur","Two sets of legs probably makes you faster right? Gain centaur stature and an extra set of legs but miss out on back items. Matching sets of legs make you even cooler.",stars=2),
    BodyPlanItem("shieldcaptain:pipe_frame_chassis","Pipe Frame Chassis","No armour? No problem. Feel the wind in your hair and the lack of all nonessential safety equipment at your very exposed sides.",["body"],stars=2),
