...
[
    ...
    KitItem("immateria:formless_shell", "Formless Shell", "Coats your armor in a layer of immateria, which can be activated to temoporarily send any projectiles or weapons that hit it Elsewhere. Has to be activated before the hit to work, and has a long cooldown.", stars=3),
])
