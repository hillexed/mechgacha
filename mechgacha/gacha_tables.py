...
[
    ...
    BodyPlanItem("shork:clusterbot","Clusterbot","What appears to be a standard mech has a secret trick: It can split into two bodies! They share equipped power, body and cockpit parts, but all other parts must be assigned to a specific half.", {"legs": 4, "arms": 4}, stars=5),
