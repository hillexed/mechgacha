...
[
    ...
    KitItem("immateria:formless_shell", "Formless Shell", "A coating of immateria for your mech, given to you by some unknown force beyond understanding. Can be activated to send any projectiles or weapons that hit it Elsewhere for a turn, with them reappearing where they were upon contact. Has a short cooldown between uses.", stars=3),
])
