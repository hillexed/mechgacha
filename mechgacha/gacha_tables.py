...
[
    ...
    WeaponItem("event_fauna:ditto","Volt Beetle Horn","This horn seems to be inspired by the Volt Beetles that live in the Core, slowly generating a static charge that can be released to stun opponents.",["cockpit"],stars=3,tags=("event",)),
