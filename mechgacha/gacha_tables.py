...
bee = Mech("bee", [
    ...
    CosmeticItem("bee:artificial_satellite","Artificial Satellite","A small artificial space structure (a satellite, space ship, etc) orbits your mech.",["Drone","Space"], stars=3),
