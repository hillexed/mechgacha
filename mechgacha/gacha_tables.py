...
[
    ...
    CosmeticItem("syl:tied_up_horse", "Tied-Up Horse","This mech has a horse tied up to one of its legs. Not sure how it stays there in combat.",["Horse"]),
    ...
    WeaponItem("syl:horse_summoning_staff","Horse Summoning Staff","Summons normal but very angry horses to fight alongside you.",["Horse"],stars=3),
    ...
    CockpitItem("syl:epona","Epona","This iconic horse has blocky N64-era graphics but a pure heart. Pilots your mech for you and is “equipped” as a second cockpit.",["Horse"],stars=3),
