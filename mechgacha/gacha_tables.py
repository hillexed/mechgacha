...
[   
    ...
    ArmsItem("hal2000:cobbled_scrap_arms","Glistening Ichor Punchers","After much use, an odd oil is now dripping out of these Glistening Platinum Punchers. They’re still durable and lithe, but any enemy mech that touches the ichor will find their computer systems slowly corrupted and the mech’s operating fluid infected by ichor. Maybe these were scrapped for a reason...", stars=4),
    ...
    KitItem("hal2000:glutton","Glutton","They say you are what you eat, and that's true! Gives your mech a giant mouth and working system of stomachs. Your mech can additionally gain the abilities of any part it eats off the enemy mech, with your mech congealing a fleshy replica as it's digested.", stars=4),
