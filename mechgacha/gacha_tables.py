...
[
	...
	BodyPlanItem("jkbenbot:revocorp_prebuilt_mech","RevoCorp Prebuilt Mech","A prebuilt mech made by the fine folks at RevoCorp, This prebuilt comes with a grappling beam to pull ranged opponents in, and an energy blade to cut down opponents. [0 Slots]",{"arms":0,"legs":0},stars=2),
