...
[
    ...
    BodyPlanItem("shork:clusterbot","Clusterbot","What appears to be a standard mech has a secret trick: It can split into two independently controlled halves!", {"legs": 4, "arms": 4}, stars=5),
