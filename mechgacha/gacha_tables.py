...
[
    ...
    WeaponItem("st_yietus:rattlegun","RATTLEGUN","A crude mech-grade automatic weapon, built quickly to be discarded just as fast... and yet, this one shows signs of care and customization.", stars=1),
...
[
	...
	BackItem("jcterran:lidar_designator","LIDAR Designator","A dedicated scanning module, paired with an analysis sub-Ai. With a few moments of active scanning, can identify weak points in enemies, and transmit the information to nearby allies.",["Luminous","Sensory"],stars=2),
	KitItem("jcterran:temporal_shell","Temporal Shell","A bizarre, silvery device. Activation projects a small subspace bubble around the user's mech, at an exorbitant price in energy and waste heat. Local times flows three times as fast within the bubble, though it lasts only five seconds of realtime before fail-safes force a shutdown.",["Space"],stars=4),
