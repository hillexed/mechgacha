...
[
    ...
    CosmeticItem("cheshire:viewing_chambers","Viewing chambers","Glass that allows you to see the mechanisms inside of the machine."),
    ...
    WeaponItem("cheshire:gorgons_grace","Gorgon's Grace","Inscribed with terrifying images, this object calcifies and embrittles those that gaze upon it, corroding armor and spirit. Ranged", stars=5),	
...
[
    ...
    BackItem("shork:apd_unit","APD Unit","An array of scaffolding designed to keep dangerous foes out of reach. Also handy if you get stuck in a hole.", stars=2),
    ...
    CosmeticItem("shork:polkadot_fur","Polkadot Fur","Offers no tactical advantage whatsoever.", stars=2),
    ...
    WeaponItem("shork:flippaaaaaaaaah","FLIPPAAAAAAAAAH","A pneumatic panel designed for pushing potential pugilists before they pounce.", stars=2),
    ...
    BackItem("shork:full_body_spinner","Full Body Spinner","A giant blade of metal orbiting your mech at ungodly speeds, fuelled by the biggest ICE we could strap on its back. Kinetic energy in its purest form.", stars=5),
    ...
    KitItem("shork:meltybrain_unit","MeltyBrain Unit","A program that micro-adjusts drive motors, allowing for translational movement whilst the entire mech spins at high speed.", stars=3),
    ...
    WeaponItem("shork:pneumatic_spear","Pneumatic Spear","A pneumatically powered retracting lance, built for skewering or shoving foes.",stars=1),
    ...
    ArmsItem("shork:jaws_of_life","Jaws of Life","These arms have hydraulic crushers in place of hands, ideal for cutting through metal. Very good for grabbing and crushing, but you may struggle to avoid damaging handheld weaponry.",stars=2),
    LegsItem("shork:magnetic_treads","Magnetic Treads","Heavy tank-style tracks. Each slat of the treads is magnetized, allowing for even stronger grip on metal flooring.",stars=2),
    BodyPlanItem("shork:wide","WIDEEEEEEEEEEEEEEEEEE","An extremely long series of flexible panels connects the left and right halves of your bot together, allowing you to wrap around your opposition and attack from odd angles.", {"legs":2,"arms":2},stars=2),
    ...
    KitItem("shork:mysterious_present","Mysterious Present","A large, gift-wrapped cardboard box, containing a surprise for your opponent once they tear into it... It's nets. The box is full of entangling nets.",stars=2),
    LegsItem("shork:huge_wheels","Huge Wheels","Gigantic UHMW plastic wheels, with a diameter several times larger than the chassis of your mech. These wheels can seriously flex when struck, reducing the power of impacts, but have poor traction resulting in a slippery ride.",stars=3),
    ...
    BackItem("shork:downforce_generator","Downforce Generator","This module sucks... your mech down to the ground. Rubber skirts and a rear-mounted fan generate a vacuum around your mech's base, pulling it down tight against the ground when activated.",stars=3),
    ...
    CockpitItem("shork:commentators_booth","Commentators' Booth","Two very shouty people accompany you in a floating booth. They're here to hype up the crowd, heckle your opponent, and provide live commentary over the ensuing battle.",stars=5),
...
[   
    ...
    CosmeticItem("hal2000:clown_face","Clown Face Paint","+1000 Clown Vibes, +200 Fear Induced", stars=3),
