...
[
    ...
    BodyPlanItem("zapterra:standard_frame","Standard Frame","Locks everything in the upper body into place, disrupting and redistributing any impacts to the system. Forgoes the use of held weapons, instead favoring the use of momentum and rotation of the entire upper body with occasional kicks. The lead's back needs to stay clear for their number!",{"legs":4,"weapons":0,"body":2,"cockpit":2,"power":2},stars=4),
