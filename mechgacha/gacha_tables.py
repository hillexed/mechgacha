...
[
    ...
    BodyPlanItem("st_yierus:supertitan_body_plan","SUPERTITAN BODY PLAN","We've all asked ourselves the question: what if, instead of adding more parts to a mech, we just made it bigger? Now, finally, the answer is here! I ask a new question: who needs agility when you have overwhelming force?", stars=4),
