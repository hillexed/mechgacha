...
[
    ...
    BodyPlanItem("Loading:Power_Vents","Core Ventilation","In exchange for a more trimmed down mech you gain the ability to explosively vent waste from your power source once per fight. While this is considered a weapon it does not occupy a slot", ["weapon"], stars=4),
