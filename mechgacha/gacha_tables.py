...
[
    ...
    Item("ditto:giant_wind","Giant wind","up key (Decorative version): Playing with toys.", ["back"], stars=2),
    Item("ditto:comically_large_spoon","Comically Large Spoon","Perfect for ice cream! And also a reference to a vine nobody probably remembers.", ["weapon"], stars=3),
    Item("ditto:cool_hat","Cool hat","It's a really cool hat", ["cosmetic"], stars=4),

    LegsItem("ditto:hover_core","Hover core","Who needs Legs?"),
    BodyPlanItem("ditto:ex_blueprint","EX Blueprint","Who needs Arms with legs like these? ...No seriously who needs them, this doesn't have any. If you want an answer as to how it holds things, ROBOT TELEKINESIS.", {"legs":1,"arms":0}, stars=2),
    ...
    BodyItem("ditto:advanced_blender_cube","ADVANCED Blender cube","It looks like a gray default blender cube with a cockpit attached. But it's ADVANCED! ... I ran out of ideas here, ok.", stars=5),
]
)
