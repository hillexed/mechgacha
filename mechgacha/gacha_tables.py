...
[
    ...
    LegsItem("st_yietus:rotborn_stomper","ROTBORN STOMPER","Sturdy weatherproofed legs. Slow and steady, but surprisingly agile. Capable of performing short leaps and dashes to clear obstacles or close the distance. Slightly reduces the effects of debuffs.", stars=2),
    ArmsItem("st_yietus:rotborn_fist","ROTBORN FIST","Simple arms, covered in pitted armor and tipped with a large, gauntlet-like hand. Paired with small remote manipulators for more delicate work. Even unarmed, they bear enough strength to break through any barriers set in your path. Slightly reduces the effects of debuffs.", stars=2),
